(function (){"use strict";// build/debug/tmp_modules/node/wasi.ts
var $;
var nodeFsConstants = @processBindingConstants.fs;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __commonJS = (cb, mod = @undefined) => function __require2() {
        ...
        this.wasiImport = {
          args_get: (argv, argvBuf) => {
            ...
            args.forEach((a) => {
              ...
              coffset += 4;
              offset += @Buffer.from(this.memory.buffer).write(`${a}\x00`, offset);
            });
          ...
          environ_get: (environ, environBuf) => {
            ...
            Object.entries(this.env).forEach(([key, value]) => {
              this.view.setUint32(coffset, offset, true);
              coffset += 4;
              offset += @Buffer.from(this.memory.buffer).write(`${key}=${value}\x00`, offset);
            });
            return constants_1.WASI_ESUCCESS;
          },
