...
let $assert = function(check, sourceString, ...message) {
  if (!check) {
    ...
    console.error('[zlib] ASSERTION FAILED: ' + sourceString);
...
var $;
var BufferModule = @getInternalField(@internalModuleRegistry, 141) || @createInternalModuleById(141);
var crc32 = @lazy(91);
var NativeZlib = @lazy(92);
var NativeBrotli = @lazy(93);
var NativeZstd = @lazy(94);
var ObjectKeys = Object.keys;
var ArrayPrototypePush = @Array.prototype.push;
var ObjectDefineProperty = Object.defineProperty;
var ObjectDefineProperties = Object.defineProperties;
var ObjectFreeze = Object.freeze;
var TypedArrayPrototypeFill = @Uint8Array.prototype.fill;
var ArrayPrototypeForEach = @Array.prototype.forEach;
var NumberIsNaN = Number.isNaN;
var MathMax = Math.max;
var ArrayBufferIsView = @ArrayBuffer.isView;
var isArrayBufferView = ArrayBufferIsView;
var isAnyArrayBuffer = (b) => b instanceof @ArrayBuffer || b instanceof SharedArrayBuffer;
var kMaxLength = @requireMap.@get("buffer")?.exports.kMaxLength ?? BufferModule.kMaxLength;
var { Transform, finished } = @getInternalField(@internalModuleRegistry, 117) || @createInternalModuleById(117);
var owner_symbol = Symbol("owner_symbol");
var { checkRangesOrGetDefault, validateFunction, validateFiniteNumber } = @getInternalField(@internalModuleRegistry, 68) || @createInternalModuleById(68);
...
function zlibBufferOnData(chunk) {
  ...
  if (this.nread > this._maxOutputLength) {
    ...
    this.cb(@makeErrorWithCode(13, this._maxOutputLength));
  }
}
  ...
  while (true) {
    ...
    if (have > 0) {
      ...
      if (nread > self._maxOutputLength) {
        _close(self);
        throw @makeErrorWithCode(13, self._maxOutputLength);
      }
    } else {
