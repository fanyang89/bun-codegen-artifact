...
$ = {
  ...
  monitorEventLoopDelay: function monitorEventLoopDelay(options) {
    const impl = @getInternalField(@internalModuleRegistry, 29) || @createInternalModuleById(29);
    return impl(options);
  },
