(function (){"use strict";// build/debug/tmp_modules/node/test.ts
var $;
var { jest } = Bun;
var { kEmptyObject, throwNotImplemented } = @getInternalField(@internalModuleRegistry, 32) || @createInternalModuleById(32);
