(function (){"use strict";// build/debug/tmp_modules/node/crypto.ts
var $;
var StringDecoder = (@getInternalField(@internalModuleRegistry, 143) || @createInternalModuleById(143)).StringDecoder;
var LazyTransform = @getInternalField(@internalModuleRegistry, 49) || @createInternalModuleById(49);
...
var { isAnyArrayBuffer, isArrayBufferView } = @getInternalField(@internalModuleRegistry, 144) || @createInternalModuleById(144);
...
};
{
  ...
  @toClass(Cipheriv2, "Cipheriv", LazyTransform);
  ...
  @toClass(Decipheriv2, "Decipheriv", LazyTransform);
