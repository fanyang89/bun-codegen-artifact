(function (){"use strict";// build/debug/tmp_modules/node/_http_outgoing.ts
var $;
var { Stream } = @getInternalField(@internalModuleRegistry, 40) || @createInternalModuleById(40);
var { isUint8Array, validateString } = @getInternalField(@internalModuleRegistry, 68) || @createInternalModuleById(68);
