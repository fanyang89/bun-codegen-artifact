(function (){"use strict";// build/debug/tmp_modules/bun/sql.ts
var $;
var { Query, SQLQueryFlags } = @getInternalField(@internalModuleRegistry, 36) || @createInternalModuleById(36);
var { PostgresAdapter } = @getInternalField(@internalModuleRegistry, 35) || @createInternalModuleById(35);
var { MySQLAdapter } = @getInternalField(@internalModuleRegistry, 34) || @createInternalModuleById(34);
var { SQLiteAdapter } = @getInternalField(@internalModuleRegistry, 38) || @createInternalModuleById(38);
var { SQLHelper, parseOptions } = @getInternalField(@internalModuleRegistry, 37) || @createInternalModuleById(37);
var { SQLError, PostgresError, SQLiteError, MySQLError } = @getInternalField(@internalModuleRegistry, 33) || @createInternalModuleById(33);
