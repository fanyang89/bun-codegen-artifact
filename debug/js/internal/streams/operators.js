(function (){"use strict";// build/debug/tmp_modules/internal/streams/operators.ts
var $;
var { validateAbortSignal, validateInteger, validateObject } = @getInternalField(@internalModuleRegistry, 68) || @createInternalModuleById(68);
var { kWeakHandler, kResistStopPropagation } = @getInternalField(@internalModuleRegistry, 32) || @createInternalModuleById(32);
var { finished } = @getInternalField(@internalModuleRegistry, 47) || @createInternalModuleById(47);
var staticCompose = @getInternalField(@internalModuleRegistry, 42) || @createInternalModuleById(42);
var { addAbortSignalNoValidate } = @getInternalField(@internalModuleRegistry, 41) || @createInternalModuleById(41);
var { isWritable, isNodeStream } = @getInternalField(@internalModuleRegistry, 58) || @createInternalModuleById(58);
