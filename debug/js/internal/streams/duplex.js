(function (){"use strict";// build/debug/tmp_modules/internal/streams/duplex.ts
var $;
...
var { kOnConstructed } = @getInternalField(@internalModuleRegistry, 58) || @createInternalModuleById(58);
...
Duplex.from = function(body) {
  duplexify ??= @getInternalField(@internalModuleRegistry, 45) || @createInternalModuleById(45);
