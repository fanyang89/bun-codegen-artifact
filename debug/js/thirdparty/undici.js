(function (){"use strict";// build/debug/tmp_modules/thirdparty/undici.ts
var $;
var EventEmitter = @getInternalField(@internalModuleRegistry, 96) || @createInternalModuleById(96);
var StreamModule = @getInternalField(@internalModuleRegistry, 117) || @createInternalModuleById(117);
var { Readable } = StreamModule;
var { _ReadableFromWeb: ReadableFromWeb } = @getInternalField(@internalModuleRegistry, 69) || @createInternalModuleById(69);
var ObjectCreate = Object.create;
var kEmptyObject = ObjectCreate(null);
var fetch = Bun.fetch;
var bindings = @lazy(96);
