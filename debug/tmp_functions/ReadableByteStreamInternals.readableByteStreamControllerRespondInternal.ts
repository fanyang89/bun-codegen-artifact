...
$$capture_start$$(function(controller,bytesWritten) {  let firstDescriptor: PullIntoDescriptor | undefined = __intrinsic__getByIdDirectPrivate(controller, "pendingPullIntos").peek();
