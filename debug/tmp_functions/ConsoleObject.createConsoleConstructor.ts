...
$$capture_start$$(function(console) {  const { inspect, formatWithOptions } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 126/*node:util*/) || __intrinsic__createInternalModuleById(126/*node:util*/));
  const { isBuffer } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 141/*node:buffer*/) || __intrinsic__createInternalModuleById(141/*node:buffer*/));

  const { validateObject, validateInteger, validateArray, validateOneOf } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68/*internal/validators*/) || __intrinsic__createInternalModuleById(68/*internal/validators*/));
  ...
  function Console(this: any, options /* or: stdout, stderr, ignoreErrors = true */): void {
    ...
    if (!stdout || typeof stdout.write !== "function") {
      throw __intrinsic__makeErrorWithCode(17, "stdout is not a writable stream");
    }
    if (!stderr || typeof stderr.write !== "function") {
      throw __intrinsic__makeErrorWithCode(17, "stderr is not a writable stream");
    }
    ...
    if (inspectOptions !== undefined) {
      ...
      if (inspectOptions.colors !== undefined && options.colorMode !== undefined) {
        throw __intrinsic__makeErrorWithCode(115, 
