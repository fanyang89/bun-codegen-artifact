...
$$capture_start$$(function(reason) {  if (!__intrinsic__isReadableStreamDefaultReader(this)) return Promise.__intrinsic__reject(__intrinsic__makeErrorWithCode(138, "ReadableStreamDefaultReader"));
