// @bun
// build/debug/tmp_modules/thirdparty/undici.ts
var $;
...
var StreamModule = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 117) || __intrinsic__createInternalModuleById(117);
var { Readable } = StreamModule;
var { _ReadableFromWeb: ReadableFromWeb } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 69) || __intrinsic__createInternalModuleById(69);
var ObjectCreate = Object.create;
var kEmptyObject = ObjectCreate(null);
var fetch = Bun.fetch;
var bindings = __intrinsic__lazy(96);
var Response = bindings[0];
var Request = bindings[1];
var Headers = bindings[2];
var FormData = bindings[3];
var File = bindings[4];
var URL = bindings[5];
var AbortSignal = bindings[6];
var URLSearchParams = bindings[7];
var WebSocket = bindings[8];
var CloseEvent = bindings[9];
var ErrorEvent = bindings[10];
var MessageEvent = bindings[11];
