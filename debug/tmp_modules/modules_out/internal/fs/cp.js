// @bun
// build/debug/tmp_modules/internal/fs/cp.ts
var $;
var { chmod, copyFile, lstat, mkdir, opendir, readlink, stat, symlink, unlink, utimes } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 97) || __intrinsic__createInternalModuleById(97);
...
function pathExists(dest) {
  return PromisePrototypeThen.__intrinsic__call(stat(dest), () => true, (err) => err.code === "ENOENT" ? false : PromiseReject(err));
}
