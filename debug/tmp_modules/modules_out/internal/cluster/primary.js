// @bun
// build/debug/tmp_modules/internal/cluster/primary.ts
var $;
...
var RoundRobinHandle = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 9) || __intrinsic__createInternalModuleById(9);
var path = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 107) || __intrinsic__createInternalModuleById(107);
var { throwNotImplemented, kHandle } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32) || __intrinsic__createInternalModuleById(32);
var sendHelper = __intrinsic__lazy(3);
var onInternalMessage = __intrinsic__lazy(7);
var child_process;
...
function createWorkerProcess(id, env) {
  ...
  child_process ??= __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 87) || __intrinsic__createInternalModuleById(87);
