// @bun
// build/debug/tmp_modules/internal/util/inspect.ts
var $;
var { pathToFileURL } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 125) || __intrinsic__createInternalModuleById(125);
var BufferModule;
var primordials = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 30) || __intrinsic__createInternalModuleById(30);
var { uncurryThis } = primordials;
var {
  MapPrototypeGetSize,
  SafeMap,
  SafeSet,
...
var ArrayFrom = __intrinsic__Array.from;
var ArrayPrototypeFilter = uncurryThis(__intrinsic__Array.prototype.filter);
var ArrayPrototypeFlat = uncurryThis(__intrinsic__Array.prototype.flat);
var ArrayPrototypeForEach = uncurryThis(__intrinsic__Array.prototype.forEach);
var ArrayPrototypeIncludes = uncurryThis(__intrinsic__Array.prototype.includes);
var ArrayPrototypeIndexOf = uncurryThis(__intrinsic__Array.prototype.indexOf);
var ArrayPrototypeJoin = uncurryThis(__intrinsic__Array.prototype.join);
var ArrayPrototypeMap = uncurryThis(__intrinsic__Array.prototype.map);
var ArrayPrototypePop = uncurryThis(__intrinsic__Array.prototype.pop);
var ArrayPrototypePush = __intrinsic__Array.prototype.push;
var ArrayPrototypeSlice = uncurryThis(__intrinsic__Array.prototype.slice);
var ArrayPrototypeSplice = uncurryThis(__intrinsic__Array.prototype.splice);
var ArrayPrototypeSort = uncurryThis(__intrinsic__Array.prototype.sort);
var ArrayPrototypeUnshift = uncurryThis(__intrinsic__Array.prototype.unshift);
var BigIntPrototypeValueOf = uncurryThis(BigInt.prototype.valueOf);
var BooleanPrototypeValueOf = uncurryThis(Boolean.prototype.valueOf);
var DatePrototypeGetTime = uncurryThis(Date.prototype.getTime);
var DatePrototypeToISOString = uncurryThis(Date.prototype.toISOString);
var DatePrototypeToString = uncurryThis(Date.prototype.toString);
var ErrorCaptureStackTrace = Error.captureStackTrace;
var ErrorPrototypeToString = uncurryThis(Error.prototype.toString);
var FunctionPrototypeBind = uncurryThis(Function.prototype.bind);
var FunctionPrototypeToString = uncurryThis(Function.prototype.toString);
var JSONStringify = JSON.stringify;
var MapPrototypeEntries = uncurryThis(Map.prototype.entries);
var MapPrototypeValues = uncurryThis(Map.prototype.values);
var MapPrototypeKeys = uncurryThis(Map.prototype.keys);
...
var NumberParseFloat = Number.parseFloat;
var NumberParseInt = Number.parseInt;
var NumberPrototypeToString = uncurryThis(Number.prototype.toString);
var NumberPrototypeValueOf = uncurryThis(Number.prototype.valueOf);
...
var ObjectPrototypeHasOwnProperty = uncurryThis(Object.prototype.hasOwnProperty);
var ObjectPrototypePropertyIsEnumerable = uncurryThis(Object.prototype.propertyIsEnumerable);
var ObjectPrototypeToString = uncurryThis(Object.prototype.toString);
var ObjectSeal = Object.seal;
var ObjectSetPrototypeOf = Object.setPrototypeOf;
var ReflectOwnKeys = Reflect.ownKeys;
var RegExpPrototypeExec = uncurryThis(__intrinsic__RegExp.prototype.exec);
var RegExpPrototypeSymbolReplace = uncurryThis(__intrinsic__RegExp.prototype[Symbol.replace]);
var RegExpPrototypeSymbolSplit = uncurryThis(__intrinsic__RegExp.prototype[Symbol.split]);
var RegExpPrototypeTest = uncurryThis(__intrinsic__RegExp.prototype.test);
var RegExpPrototypeToString = uncurryThis(__intrinsic__RegExp.prototype.toString);
var SetPrototypeEntries = uncurryThis(Set.prototype.entries);
var SetPrototypeValues = uncurryThis(Set.prototype.values);
var StringPrototypeCharCodeAt = uncurryThis(__intrinsic__String.prototype.charCodeAt);
var StringPrototypeIncludes = uncurryThis(__intrinsic__String.prototype.includes);
var StringPrototypeIndexOf = uncurryThis(__intrinsic__String.prototype.indexOf);
var StringPrototypeLastIndexOf = uncurryThis(__intrinsic__String.prototype.lastIndexOf);
var StringPrototypeMatch = uncurryThis(__intrinsic__String.prototype.match);
var StringPrototypeNormalize = uncurryThis(__intrinsic__String.prototype.normalize);
var StringPrototypePadEnd = uncurryThis(__intrinsic__String.prototype.padEnd);
var StringPrototypePadStart = uncurryThis(__intrinsic__String.prototype.padStart);
var StringPrototypeRepeat = uncurryThis(__intrinsic__String.prototype.repeat);
var StringPrototypeReplaceAll = uncurryThis(__intrinsic__String.prototype.replaceAll);
var StringPrototypeSlice = uncurryThis(__intrinsic__String.prototype.slice);
var StringPrototypeSplit = uncurryThis(__intrinsic__String.prototype.split);
var StringPrototypeEndsWith = uncurryThis(__intrinsic__String.prototype.endsWith);
var StringPrototypeStartsWith = uncurryThis(__intrinsic__String.prototype.startsWith);
var StringPrototypeToLowerCase = uncurryThis(__intrinsic__String.prototype.toLowerCase);
var StringPrototypeTrim = uncurryThis(__intrinsic__String.prototype.trim);
var StringPrototypeValueOf = uncurryThis(__intrinsic__String.prototype.valueOf);
var SymbolPrototypeToString = uncurryThis(Symbol.prototype.toString);
var SymbolPrototypeValueOf = uncurryThis(Symbol.prototype.valueOf);
...
var extractedSplitNewLinesFastPathStringsOnly = __intrinsic__lazy(19);
...
class AssertionError extends Error {
  constructor(message, isForced = false) {
    ...
    this.actual = isForced && __intrinsic__undefined;
    this.expected = !isForced || __intrinsic__undefined;
  }
}
...
var codes = {};
{
  ...
  messages.set(sym, (name, expected, actual) => {
    ...
    if (!__intrinsic__isJSArray(expected))
      expected = [expected];
    let msg = "The ";
    ...
    for (const value of expected) {
      ...
      if (ArrayPrototypeIncludes(kTypes, value))
        ...
        ArrayPrototypePush.__intrinsic__call(other, value);
      }
    }
    if (instances.length > 0) {
      ...
      if (pos !== -1) {
        ...
        ArrayPrototypePush.__intrinsic__call(instances, "Object");
      }
    }
    if (types.length > 0) {
      if (types.length > 2)
  ...
  codes[sym] = function NodeError(...args) {
    ...
    const message = msg.__intrinsic__apply(error, args);
    ...
    Error.stackTraceLimit = __intrinsic__Infinity;
...
var isUndetectableObject = (v) => typeof v === "undefined" && v !== __intrinsic__undefined;
...
var extractedSplitNewLinesSlow;
try {
  strEscapeSequencesRegExp = new __intrinsic__RegExp("[\\x00-\\x1f\\x27\\x5c\\x7f-\\x9f]|[\\ud800-\\udbff](?![\\udc00-\\udfff])|(?<![\\ud800-\\udbff])[\\udc00-\\udfff]");
  strEscapeSequencesReplacer = new __intrinsic__RegExp("[\x00-\\x1f\\x27\\x5c\\x7f-\\x9f]|[\\ud800-\\udbff](?![\\udc00-\\udfff])|(?<![\\ud800-\\udbff])[\\udc00-\\udfff]", "g");
  strEscapeSequencesRegExpSingle = new __intrinsic__RegExp("[\\x00-\\x1f\\x5c\\x7f-\\x9f]|[\\ud800-\\udbff](?![\\udc00-\\udfff])|(?<![\\ud800-\\udbff])[\\udc00-\\udfff]");
  strEscapeSequencesReplacerSingle = new __intrinsic__RegExp("[\\x00-\\x1f\\x5c\\x7f-\\x9f]|[\\ud800-\\udbff](?![\\udc00-\\udfff])|(?<![\\ud800-\\udbff])[\\udc00-\\udfff]", "g");
  const extractedNewLineRe = new __intrinsic__RegExp("(?<=\\n)");
...
function initializeWellKnownPrototypes() {
  ...
  wellKnownPrototypes.set(__intrinsic__Array.prototype, { name: "Array", constructor: __intrinsic__Array });
  wellKnownPrototypes.set(__intrinsic__ArrayBuffer.prototype, { name: "ArrayBuffer", constructor: __intrinsic__ArrayBuffer });
...
function getConstructorName(obj, ctx, recurseTimes, protoProps) {
  ...
  while (obj || isUndetectableObject(obj)) {
    ...
    if (firstProto === __intrinsic__undefined) {
      firstProto = obj;
    }
  }
  if (firstProto === null) {
...
function addPrototypeProperties(ctx, main, obj, recurseTimes, output) {
  ...
  do {
    ...
    ArrayPrototypePush.__intrinsic__call(ctx.seen, main);
...
function formatValue(ctx, value, recurseTimes, typedArray) {
  ...
  if (ctx.customInspect) {
    ...
    if (typeof maybeCustom === "function" && maybeCustom !== inspect && Object.getOwnPropertyDescriptor(value, "constructor")?.value?.prototype !== value) {
      ...
      const isCrossContext = proxy !== __intrinsic__undefined || !(context instanceof Object);
...
function formatRaw(ctx, value, recurseTimes, typedArray) {
  ...
  if (SymbolIterator in value || constructor === null) {
    ...
    if (__intrinsic__isJSArray(value)) {
      ...
      braces = [`${prefix}[`, "]"];
      if (value.length === 0 && keys.length === 0 && protoProps === __intrinsic__undefined)
        return `${braces[0]}]`;
      ...
      if (size === 0 && keys.length === 0 && protoProps === __intrinsic__undefined)
        return `${prefix}{}`;
      braces = [`${prefix}{`, "}"];
    } else if (isMap(value)) {
  ...
  try {
    ...
    throw new AssertionError("handleMaxCallStackSize assertion failed: " + __intrinsic__String(err), true);
  }
  if (ctx.circular !== __intrinsic__undefined) {
  ...
  ctx.seen.pop();
  if (ctx.sorted) {
    const comparator = ctx.sorted === true ? __intrinsic__undefined : ctx.sorted;
    if (extrasType === kObjectType) {
      ...
      ArrayPrototypeSplice.__intrinsic__apply(null, sorted);
    }
  }
...
function identicalSequenceRange(a, b) {
  for (let i = 0;i < a.length - 3; i++) {
    const pos = ArrayPrototypeIndexOf.__intrinsic__call(b, a[i]);
    if (pos !== -1) {
      const rest = b.length - pos;
      if (rest > 3) {
        let len = 1;
        const maxLen = __intrinsic__min(a.length - i, rest);
...
function formatError(err, constructor, tag, ctx, keys) {
  const name = err.name != null ? __intrinsic__String(err.name) : "Error";
...
`;
          ...
          if (workingDirectory !== __intrinsic__undefined) {
...
function groupArrayElements(ctx, output, value) {
  ...
  const dataLen = new __intrinsic__Array(outputLength);
  ...
  if (actualMax * 3 + ctx.indentationLvl < ctx.breakLength && (totalLength / actualMax > 5 || maxLength <= 6)) {
    ...
    const columns = __intrinsic__min(MathRound(MathSqrt(approxCharHeights * biasedMax * outputLength) / biasedMax), MathFloor((ctx.breakLength - ctx.indentationLvl) / actualMax), ctx.compact * 4, 15);
    if (columns <= 1) {
      return output;
    }
    const tmp = [];
    ...
    for (let i2 = 0;i2 < outputLength; i2 += columns) {
      const max = __intrinsic__min(i2 + columns, outputLength);
      let str = "";
      let j = i2;
      for (;j < max - 1; j++) {
...
function formatNumber(fn, number, numericSeparator) {
  ...
  const string = __intrinsic__String(integer);
  if (integer === number) {
...
function formatBigInt(fn, bigint, numericSeparator) {
  const string = __intrinsic__String(bigint);
  if (!numericSeparator) {
...
function formatNamespaceObject(keys, ctx, value, recurseTimes) {
  const output = new __intrinsic__Array(keys.length);
...
function formatSpecialArray(ctx, value, recurseTimes, maxLength, output, i) {
  ...
  for (;i < keys.length && output.length < maxLength; i++) {
    ...
    ArrayPrototypePush.__intrinsic__call(output, formatProperty(ctx, value, recurseTimes, key, kArrayType));
    index++;
  }
...
function formatArrayBuffer(ctx, value) {
  ...
  let str = StringPrototypeTrim(RegExpPrototypeSymbolReplace(/(.{2})/g, hexSlice(buffer, 0, __intrinsic__min(ctx.maxArrayLength, buffer.length)), "$1 "));
...
function formatArray(ctx, value, recurseTimes) {
  ...
  const len = __intrinsic__min(MathMax(0, ctx.maxArrayLength), valLen);
...
function formatTypedArray(value, length, ctx, ignored, recurseTimes) {
  if (__intrinsic__Buffer.isBuffer(value)) {
    ...
    const INSPECT_MAX_BYTES = __intrinsic__requireMap.__intrinsic__get("buffer")?.exports.INSPECT_MAX_BYTES ?? BufferModule.INSPECT_MAX_BYTES;
    ctx.maxArrayLength = __intrinsic__min(ctx.maxArrayLength, INSPECT_MAX_BYTES);
  }
  const maxLength = __intrinsic__min(MathMax(0, ctx.maxArrayLength), length);
  const remaining = value.length - maxLength;
  const output = new __intrinsic__Array(maxLength);
...
function formatSet(value, ctx, ignored, recurseTimes) {
  ...
  for (const v of value) {
    if (i >= maxLength)
      break;
    ArrayPrototypePush.__intrinsic__call(output, formatValue(ctx, v, recurseTimes));
    i++;
  }
  if (remaining > 0) {
    ArrayPrototypePush.__intrinsic__call(output, remainingText(remaining));
...
function formatMap(value, ctx, ignored, recurseTimes) {
  ...
  for (const { 0: k, 1: v } of value) {
    if (i >= maxLength)
      break;
    ArrayPrototypePush.__intrinsic__call(output, `${formatValue(ctx, k, recurseTimes)} => ${formatValue(ctx, v, recurseTimes)}`);
    i++;
  }
  if (remaining > 0) {
    ArrayPrototypePush.__intrinsic__call(output, remainingText(remaining));
...
function formatSetIterInner(ctx, recurseTimes, entries, state) {
  ...
  const maxLength = __intrinsic__min(maxArrayLength, entries.length);
  const output = new __intrinsic__Array(maxLength);
  ctx.indentationLvl += 2;
  for (let i = 0;i < maxLength; i++) {
...
function formatMapIterInner(ctx, recurseTimes, entries, state) {
  ...
  const maxLength = __intrinsic__min(maxArrayLength, len);
  const output = new __intrinsic__Array(maxLength);
  let i = 0;
  ctx.indentationLvl += 2;
  if (state === kWeak) {
...
function formatProperty(ctx, value, recurseTimes, key, type, desc, original = value) {
  ...
  if (desc.value !== __intrinsic__undefined) {
...
${StringPrototypeRepeat(" ", ctx.indentationLvl)}`;
    ...
    const label = desc.set !== __intrinsic__undefined ? "Getter/Setter" : "Getter";
    const s = ctx.stylize;
    const sp = "special";
    if (ctx.getters && (ctx.getters === true || ctx.getters === "get" && desc.set === __intrinsic__undefined || ctx.getters === "set" && desc.set !== __intrinsic__undefined)) {
      try {
...
var internalGetStringWidth = __intrinsic__lazy(20);
...
function previewEntries(val, isIterator = false) {
  if (isIterator) {
    const iteratedObject = __intrinsic__getInternalField(val, 1);
    const kind = __intrinsic__getInternalField(val, 3);
