// @bun
// build/debug/tmp_modules/internal/http.ts
var $;
...
var getRawKeys = __intrinsic__lazy(10);
...
function callCloseCallback(self) {
  if (self[kCloseCallback]) {
    self[kCloseCallback]();
    self[kCloseCallback] = __intrinsic__undefined;
  }
}
...
var setMaxHTTPHeaderSize = __intrinsic__lazy(11);
var getMaxHTTPHeaderSize = __intrinsic__lazy(12);
