...
var { Stream, prependListener } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 50) || __intrinsic__createInternalModuleById(50);
...
var from = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 48) || __intrinsic__createInternalModuleById(48);
var { SafeSet } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 30) || __intrinsic__createInternalModuleById(30);
var { kAutoDestroyed } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32) || __intrinsic__createInternalModuleById(32);
...
var TypedArrayPrototypeSet = __intrinsic__Uint8Array.prototype.set;
...
async function* createAsyncIterator(stream, options) {
  ...
  try {
    ...
    if ((error || options?.destroyOnReturn !== false) && (error === __intrinsic__undefined || stream._readableState.autoDestroy)) {
