// @bun
// build/debug/tmp_modules/internal/sql/query.ts
var $;
...
var PublicPromise = __intrinsic__Promise;
...
class Query extends PublicPromise {
  ...
  then() {
    ...
    const result = super.__intrinsic__then.__intrinsic__apply(this, arguments);
    ...
    this.#runAsyncAndCatch();
    const result = super.catch.__intrinsic__apply(this, arguments);
    __intrinsic__markPromiseAsHandled(result);
    return result;
  }
  finally(_onfinally) {
    ...
    this.#runAsyncAndCatch();
    return super.finally.__intrinsic__apply(this, arguments);
  }
}
