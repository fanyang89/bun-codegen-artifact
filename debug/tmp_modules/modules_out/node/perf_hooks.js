// @bun
// build/debug/tmp_modules/node/perf_hooks.ts
var $;
...
var cppCreateHistogram = __intrinsic__lazy(74);
var {
  Performance,
  PerformanceEntry,
  PerformanceMark,
...
$ = {
  ...
  monitorEventLoopDelay: function monitorEventLoopDelay(options) {
    const impl = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 29) || __intrinsic__createInternalModuleById(29);
    return impl(options);
  },
