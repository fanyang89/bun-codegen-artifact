// @bun
// build/debug/tmp_modules/node/readline.ts
var $;
...
var { StringDecoder } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 143) || __intrinsic__createInternalModuleById(143);
...
var { SafeStringIterator } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 30) || __intrinsic__createInternalModuleById(30);
var {
  validateFunction,
  validateAbortSignal,
  validateArray,
...
var PromiseReject = __intrinsic__Promise.__intrinsic__reject;
var isWritable;
var { inspect } = Bun;
...
var ArrayPrototypeSort = __intrinsic__Array.prototype.sort;
...
var ArrayPrototypeReverse = __intrinsic__Array.prototype.reverse;
...
var StringPrototypeCodePointAt = __intrinsic__String.prototype.codePointAt;
  ...
  while (true) {
    ...
    if (escaped && (ch === "O" || ch === "[")) {
      ...
      if (ch === "O") {
        ...
        const cmd = StringPrototypeSlice.__intrinsic__call(s, cmdStart);
        let match;
...
`) {
      ...
      key.name = StringFromCharCode(StringPrototypeCharCodeAt.__intrinsic__call(ch, 0) + StringPrototypeCharCodeAt.__intrinsic__call("a", 0) - 1);
      key.ctrl = true;
    } else if (RegExpPrototypeExec.__intrinsic__call(/^[0-9A-Za-z]$/, ch) !== null) {
      key.name = StringPrototypeToLowerCase.__intrinsic__call(ch);
      key.shift = RegExpPrototypeExec.__intrinsic__call(/^[A-Z]$/, ch) !== null;
      key.meta = escaped;
    } else if (escaped) {
      key.name = ch.length ? __intrinsic__undefined : "escape";
      key.meta = true;
    }
    key.sequence = s;
    if (s.length !== 0 && (key.name !== __intrinsic__undefined || escaped)) {
...
function onSelfCloseWithTerminal() {
  ...
  if (output !== null && output !== __intrinsic__undefined) {
...
function InterfaceConstructor(input, output, completer, terminal) {
  ...
  if (terminal === __intrinsic__undefined && !(output == null)) {
  ...
  this[kLineObjectStream] = __intrinsic__undefined;
...
var _Interface = class Interface extends InterfaceConstructor {
  ...
  [kWriteToOutput](stringToWrite) {
    ...
    if (this.output !== null && this.output !== __intrinsic__undefined) {
  ...
  [kTabCompleter](lastKeypressWasTab, { 0: completions, 1: completeOn }) {
    ...
    if (StringPrototypeStartsWith.__intrinsic__call(prefix, completeOn) && prefix.length > completeOn.length) {
      ...
      this.line = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor - completeOn.length) + prefix + StringPrototypeSlice.__intrinsic__call(this.line, this.cursor, this.line.length);
    ...
    var width = MathMax.__intrinsic__apply(null, completionsWidth) + 2;
...
`;
  ...
  [kDeleteLeft]() {
    if (this.cursor > 0 && this.line.length > 0) {
      ...
      this.line = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor - charSize) + StringPrototypeSlice.__intrinsic__call(this.line, this.cursor, this.line.length);
  ...
  [kDeleteRight]() {
    if (this.cursor < this.line.length) {
      ...
      this.line = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor) + StringPrototypeSlice.__intrinsic__call(this.line, this.cursor + charSize, this.line.length);
      this[kRefreshLine]();
    }
  }
  [kDeleteWordLeft]() {
  ...
  [kDeleteWordRight]() {
    if (this.cursor < this.line.length) {
      ...
      this.line = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor) + StringPrototypeSlice.__intrinsic__call(trailing, match[0].length);
      this[kRefreshLine]();
    }
  }
  [kDeleteLineLeft]() {
...
class Readline {
  ...
  constructor(stream, options = __intrinsic__undefined) {
    isWritable ??= (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 117) || __intrinsic__createInternalModuleById(117)).isWritable;
  ...
  commit() {
    ...
    try {
      const data = ArrayPrototypeJoin.__intrinsic__call(this.#todo, "");
