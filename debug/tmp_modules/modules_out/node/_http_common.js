// @bun
// build/debug/tmp_modules/node/_http_common.ts
var $;
var { checkIsHttpToken } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68) || __intrinsic__createInternalModuleById(68);
var FreeList = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 19) || __intrinsic__createInternalModuleById(19);
var { methods, allMethods, HTTPParser } = process.binding("http_parser");
var incoming = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 74) || __intrinsic__createInternalModuleById(74);
