// @bun
// build/debug/tmp_modules/node/http2.ts
var $;
var { isTypedArray } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 144) || __intrinsic__createInternalModuleById(144);
...
var { STATUS_CODES } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 25) || __intrinsic__createInternalModuleById(25);
var tls = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 122) || __intrinsic__createInternalModuleById(122);
...
var { __intrinsic__data } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 97) || __intrinsic__createInternalModuleById(97);
var FileHandle = __intrinsic__data.FileHandle;
...
var kSessions = Symbol("sessions");
var kOptions = Symbol("options");
var kQuotedString = /^[\x09\x20-\x5b\x5d-\x7e\x80-\xff]*$/;
var MAX_ADDITIONAL_SETTINGS = 10;
var Stream = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 117) || __intrinsic__createInternalModuleById(117);
var { Readable } = Stream;
var TLSSocket = tls.TLSSocket;
...
var { Duplex } = Stream;
var { SafeArrayIterator, SafeSet } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 30) || __intrinsic__createInternalModuleById(30);
...
var StringPrototypeTrim = __intrinsic__String.prototype.trim;
...
var DatePrototypeToUTCString = Date.prototype.toUTCString;
var DatePrototypeGetMilliseconds = Date.prototype.getMilliseconds;
var H2FrameParser = __intrinsic__lazy(55);
var _nativeAssertSettings = __intrinsic__lazy(56);
var { upgradeRawSocketToH2 } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 70) || __intrinsic__createInternalModuleById(70);
var kSettingIds = {
  1: "headerTableSize",
  2: "enablePush",
...
function throwSettingTypeError(name, value) {
  const err = __intrinsic__makeTypeError(`Invalid value for setting "${name}": ${value}`);
  err.code = "ERR_HTTP2_INVALID_SETTING_VALUE";
  throw err;
}
function validateSettings(settings) {
  ...
  if (settings.customSettings !== __intrinsic__undefined) {
    ...
    if (keys.length > MAX_ADDITIONAL_SETTINGS) {
      ...
      err.code = "ERR_HTTP2_TOO_MANY_CUSTOM_SETTINGS";
      throw err;
    }
...
function getPackedSettings(settings) {
  ...
  const buf = __intrinsic__Buffer.alloc(entries.length * 6);
...
function getUnpackedSettings(buf, options) {
  ...
  for (let i = 0;i < buf.length; i += 6) {
    ...
    if (name) {
      ...
      customSettings[__intrinsic__String(type)] = value;
      hasCustom = true;
    }
  }
  if (hasCustom) {
...
var bunHTTP2Native = Symbol.for("::bunhttp2native::");
var bunHTTP2Socket = Symbol.for("::bunhttp2socket::");
var bunHTTP2OriginSet = Symbol("::bunhttp2originset::");
var bunHTTP2StreamFinal = Symbol.for("::bunHTTP2StreamFinal::");
var bunHTTP2StreamStatus = Symbol.for("::bunhttp2StreamStatus::");
var bunHTTP2Session = Symbol.for("::bunhttp2session::");
var bunHTTP2Headers = Symbol.for("::bunhttp2headers::");
...
var kAppendHeader = Symbol("appendHeader");
var kAborted = Symbol("aborted");
var kRequest = Symbol("request");
var kHeadRequest = Symbol("headRequest");
var kMaxStreams = 2 ** 32 - 1;
var kMaxInt = 4294967295;
var kMaxWindowSize = 2 ** 31 - 1;
var {
  validateInteger,
  validateString,
  validateObject,
...
function onStreamTrailers(trailers, flags, rawTrailers) {
  ...
  if (request !== __intrinsic__undefined) {
    ...
    ArrayPrototypePush.__intrinsic__call(request[kRawTrailers], ...new SafeArrayIterator(rawTrailers));
  }
}
...
function onStreamAbortedRequest() {
  const request = this[kRequest];
  if (request !== __intrinsic__undefined && request[kState].closed === false) {
...
function onStreamCloseResponse() {
  ...
  this[kResponse] = __intrinsic__undefined;
  res.emit("finish");
  res.emit("close");
}
function onStreamCloseRequest() {
  ...
  if (!state.didRead && !req._readableState.resumeScheduled)
    req.resume();
  this[kRequest] = __intrinsic__undefined;
  req.emit("close");
}
...
class Http2ServerRequest extends Readable {
  ...
  set method(method) {
    ...
    if (StringPrototypeTrim.__intrinsic__call(method) === "")
...
class Http2ServerResponse extends Stream {
  ...
  setTrailer(name, value) {
    ...
    name = StringPrototypeToLowerCase.__intrinsic__call(StringPrototypeTrim.__intrinsic__call(name));
  ...
  hasHeader(name) {
    validateString(name, "name");
    name = StringPrototypeToLowerCase.__intrinsic__call(StringPrototypeTrim.__intrinsic__call(name));
    return ObjectPrototypeHasOwnProperty.__intrinsic__call(this[kHeaders], name);
  }
  removeHeader(name) {
    validateString(name, "name");
  ...
  createPushResponse(headers, callback) {
    ...
    if (this[kState].closed) {
      const error = __intrinsic__makeErrorWithCode(90);
...
function onServerStream(Http2ServerRequest2, Http2ServerResponse2, stream, headers, flags, rawHeaders) {
  const server = this;
  const request = new Http2ServerRequest2(stream, headers, __intrinsic__undefined, rawHeaders);
  const response = new Http2ServerResponse2(stream);
...
var proxyCompatSocketHandler = {
  has(stream, prop) {
    const ref = stream.session !== __intrinsic__undefined ? stream.session[bunHTTP2Socket] : stream;
...
var kValidPseudoHeaders = new SafeSet([
  HTTP2_HEADER_STATUS,
  HTTP2_HEADER_METHOD,
  HTTP2_HEADER_AUTHORITY,
  HTTP2_HEADER_SCHEME,
...
var kSingleValueHeaders = new SafeSet([
  HTTP2_HEADER_STATUS,
  HTTP2_HEADER_METHOD,
  HTTP2_HEADER_AUTHORITY,
  HTTP2_HEADER_SCHEME,
...
var NoPayloadMethods = new Set([HTTP2_METHOD_DELETE, HTTP2_METHOD_GET, HTTP2_METHOD_HEAD]);
...
function markWritableDone(stream) {
  ...
  if (typeof _final === "function") {
    ...
    _final();
    stream[bunHTTP2StreamStatus] |= 32 /* WritableClosed */ | 4 /* FinalCalled */;
    return;
  }
...
function markStreamClosed(stream) {
  ...
  if ((status & 8 /* Closed */) === 0) {
    stream[bunHTTP2StreamStatus] = status | 8 /* Closed */;
...
class Http2Stream extends Duplex {
  ...
  sendTrailers(headers) {
    ...
    if ((this[bunHTTP2StreamStatus] & 2 /* WantTrailer */) === 0) {
  ...
  _final(callback) {
    ...
    if (session) {
      ...
      if (native) {
        this[bunHTTP2StreamStatus] |= 4 /* FinalCalled */;
  ...
  _read(_size) {}
    ...
    this[bunHTTP2StreamStatus] = status | 1 /* EndedCalled */;
  ...
  _writev(data, callback) {
    ...
    if (session) {
      ...
      if (native) {
        ...
        native.writeStream(this.#id, chunk, __intrinsic__undefined, false, callback);
        return;
      }
    }
...
function doSendFileFD(options, fd, headers, err, stat) {
  ...
  if (!stat.isFile()) {
    ...
    if (options.offset !== __intrinsic__undefined || options.offset > 0 || options.length !== __intrinsic__undefined || options.length >= 0 || isDirectory) {
      const err2 = isDirectory ? __intrinsic__makeErrorWithCode(101) : __intrinsic__makeErrorWithCode(100);
      tryClose(fd);
      if (onError)
        onError(err2);
      else {
  ...
  if (this.destroyed || this.closed) {
    tryClose(fd);
    this.destroy(__intrinsic__makeErrorWithCode(90));
    return;
  }
  const statOptions = {
  ...
  if (typeof options.statCheck === "function" && options.statCheck.__intrinsic__call(this, stat, headers, options) === false || this.headersSent) {
    tryClose(fd);
    return;
  }
  if (stat.isFile()) {
...
class ServerHttp2Stream extends Http2Stream {
  ...
  respond(headers, options) {
    ...
    if (endStream || statusCode === HTTP_STATUS_NO_CONTENT || statusCode === HTTP_STATUS_RESET_CONTENT || statusCode === HTTP_STATUS_NOT_MODIFIED || this.headRequest === true) {
...
function initOriginSet(session) {
  ...
  if (originSet === __intrinsic__undefined) {
    const socket = session[bunHTTP2Socket];
    session[bunHTTP2OriginSet] = originSet = new Set;
...
class ServerHttp2Session extends Http2Session {
  ...
  static #Handlers = {
    ...
    streamHeaders(self, stream, rawheaders, sensitiveHeadersValue, flags) {
      ...
      if ((status & 16 /* StreamResponded */) !== 0) {
        ...
        stream[bunHTTP2StreamStatus] = status | 16 /* StreamResponded */;
    ...
    wantTrailers(self, stream) {
      ...
      if ((status & 2 /* WantTrailer */) !== 0)
        return;
      stream[bunHTTP2StreamStatus] = status | 2 /* WantTrailer */;
    ...
    goaway(self, errorCode, lastStreamId, opaqueData) {
      if (!self)
        return;
      self.emit("goaway", errorCode, lastStreamId, opaqueData || __intrinsic__Buffer.allocUnsafe(0));
      if (errorCode !== 0) {
  ...
  altsvc(alt, originOrStream) {
    ...
    if (typeof originOrStream === "string") {
      ...
      if (originOrStream >>> 0 !== originOrStream || originOrStream === 0) {
        throw __intrinsic__makeErrorWithCode(156, "originOrStream", `> 0 && < ${2 ** 32}`, originOrStream);
      }
    ...
    origin = origin || "";
    if (__intrinsic__Buffer.byteLength(origin) + __intrinsic__Buffer.byteLength(alt) > MAX_LENGTH) {
  ...
  ping(payload, callback) {
    if (typeof payload === "function") {
      callback = payload;
      payload = __intrinsic__Buffer.alloc(8);
    } else {
    ...
    if (typeof callback === "function") {
      if (payload.byteLength !== 8) {
        const error = __intrinsic__makeErrorWithCode(97);
  ...
  destroy(error = NGHTTP2_NO_ERROR, code) {
    ...
    if (typeof error === "number") {
      code = error;
      error = code !== NGHTTP2_NO_ERROR ? __intrinsic__makeErrorWithCode(102, code) : __intrinsic__undefined;
    }
    const socket = this[bunHTTP2Socket];
    if (!this.#connected)
      return;
    ...
    if (socket) {
      this.goaway(code || constants.NGHTTP2_NO_ERROR, 0, __intrinsic__Buffer.alloc(0));
      socket.end();
    }
    const parser = this.#parser;
    if (parser) {
...
class ClientHttp2Session extends Http2Session {
  ...
  #onConnect() {
    ...
    if (socket instanceof TLSSocket) {
      if (socket.alpnProtocol !== "h2") {
        socket.end();
        const error = __intrinsic__makeErrorWithCode(80, "h2 is not supported");
        this.emit("error", error);
      }
  ...
  #onClose() {
    const parser = this.#parser;
    const err = this.connecting ? __intrinsic__makeErrorWithCode(220) : null;
    if (parser) {
  ...
  constructor(url, options, listener) {
    ...
    if (isDefaultPort) {
      const needsBrackets = StringPrototypeIncludes.__intrinsic__call(host, ":") && !StringPrototypeStartsWith.__intrinsic__call(host, "[");
    ...
    function onConnect() {
      try {
        ...
        listener?.__intrinsic__call(this, this);
      } catch (e) {
        this.destroy(e);
      }
    }
  ...
  request(headers, options) {
    try {
      ...
      if (stream_id < 0) {
        const req2 = new ClientHttp2Stream(__intrinsic__undefined, this, headers);
        process.nextTick(emitOutofStreamErrorNT, req2);
        return req2;
      }
...
function connectionListener(socket) {
  ...
  if (socket.alpnProtocol === false || socket.alpnProtocol === "http/1.1") {
    if (!this.emit("unknownProtocol", socket)) {
      ...
      socket.end(`HTTP/1.0 403 Forbidden\r
...
` + "Missing ALPN Protocol, expected `h2` to be available.\n" + "If this is a HTTP request: The server was not " + "configured with the `allowHTTP1` option or a " + "listener for the `unknownProtocol` event.\n");
  ...
  if (options.origins && __intrinsic__isArray(options.origins)) {
    try {
