...
var { parseProxyConfigFromEnv, kProxyConfig, checkShouldUseProxy, kWaitForProxyTunnel } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 25) || __intrinsic__createInternalModuleById(25);
var { getLazy, kEmptyObject, once } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32) || __intrinsic__createInternalModuleById(32);
var { validateNumber, validateOneOf, validateString } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68) || __intrinsic__createInternalModuleById(68);
...
function Agent(options) {
  ...
  if (this.options.noDelay === __intrinsic__undefined)
  ...
  if (this.maxTotalSockets !== __intrinsic__undefined) {
...
var tls = getLazy(() => __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 122) || __intrinsic__createInternalModuleById(122));
var net = getLazy(() => __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 104) || __intrinsic__createInternalModuleById(104));
...
Agent.prototype.createSocket = function createSocket(req, options, cb) {
  ...
  if (options.socketPath)
    options.path = options.socketPath;
  normalizeServerName(options, req);
  const timeout = req.timeout || this.options.timeout || __intrinsic__undefined;
  if (timeout) {
...
Agent.prototype.removeSocket = function removeSocket(s, options) {
  ...
  if (req && options) {
    req[kRequestOptions] = __intrinsic__undefined;
