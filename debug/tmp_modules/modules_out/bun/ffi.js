// @bun
// build/debug/tmp_modules/bun/ffi.ts
var $;
var FFIType = {
  "0": 0,
  "1": 1,
...
var ffiWrappers = new __intrinsic__Array(21);
var char = "val|0";
...
function FFIBuilder(params, returnType, functionToCall, name) {
  ...
  var paramNames = new __intrinsic__Array(params.length);
  var args = new __intrinsic__Array(params.length);
