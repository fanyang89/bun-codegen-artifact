...
// Sourced from src/js/internal/assert/assertion_error.ts


"use strict";

const { inspect } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 66/*internal/util/inspect*/) || __intrinsic__createInternalModuleById(66/*internal/util/inspect*/));
...
const { myersDiff, printMyersDiff, printSimpleMyersDiff } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 6/*internal/assert/myers_diff*/) || __intrinsic__createInternalModuleById(6/*internal/assert/myers_diff*/)) as typeof Internal;
