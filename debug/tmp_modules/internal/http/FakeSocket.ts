...
// Sourced from src/js/internal/http/FakeSocket.ts


const { kInternalSocketData, serverSymbol } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 25/*internal/http*/) || __intrinsic__createInternalModuleById(25/*internal/http*/));
...
const { Duplex } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 40/*internal/stream*/) || __intrinsic__createInternalModuleById(40/*internal/stream*/));
