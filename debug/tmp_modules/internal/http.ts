...
// Sourced from src/js/internal/http.ts


const { isIPv4 } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 28/*internal/net/isIP*/) || __intrinsic__createInternalModuleById(28/*internal/net/isIP*/));
...
const getRawKeys = __intrinsic__lazy(10);
...
const setMaxHTTPHeaderSize = __intrinsic__lazy(11);
const getMaxHTTPHeaderSize = __intrinsic__lazy(12);
