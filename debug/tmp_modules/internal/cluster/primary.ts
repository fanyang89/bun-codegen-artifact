...
// Sourced from src/js/internal/cluster/primary.ts
...
const Worker = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 10/*internal/cluster/Worker*/) || __intrinsic__createInternalModuleById(10/*internal/cluster/Worker*/));
const RoundRobinHandle = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 9/*internal/cluster/RoundRobinHandle*/) || __intrinsic__createInternalModuleById(9/*internal/cluster/RoundRobinHandle*/));
...
const { throwNotImplemented, kHandle } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32/*internal/shared*/) || __intrinsic__createInternalModuleById(32/*internal/shared*/));

const sendHelper = __intrinsic__lazy(3);
const onInternalMessage = __intrinsic__lazy(7);
...
function createWorkerProcess(id, env) {
  ...
  child_process ??= (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 87/*node:child_process*/) || __intrinsic__createInternalModuleById(87/*node:child_process*/));
