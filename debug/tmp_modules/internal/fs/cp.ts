...
const { chmod, copyFile, lstat, mkdir, opendir, readlink, stat, symlink, unlink, utimes } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 97/*node:fs/promises*/) || __intrinsic__createInternalModuleById(97/*node:fs/promises*/));
const { dirname, isAbsolute, join, parse, resolve, sep } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 107/*node:path*/) || __intrinsic__createInternalModuleById(107/*node:path*/));
