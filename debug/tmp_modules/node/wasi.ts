...
// Sourced from src/js/node/wasi.ts
  ...
  "node_modules/wasi-js/dist/wasi.js"(exports) {
    ...
    function getDefaults() {
      ...
      const defaultBindings = {
        ...
        isTTY: fd => (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 124/*node:tty*/) || __intrinsic__createInternalModuleById(124/*node:tty*/)).isatty(fd),
        ...
        path: (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 107/*node:path*/) || __intrinsic__createInternalModuleById(107/*node:path*/)),
      };
