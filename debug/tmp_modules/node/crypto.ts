...
// Sourced from src/js/node/crypto.ts


// Hardcoded module "node:crypto"
const StringDecoder = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 143/*node:string_decoder*/) || __intrinsic__createInternalModuleById(143/*node:string_decoder*/)).StringDecoder;
const LazyTransform = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 49/*internal/streams/lazy_transform*/) || __intrinsic__createInternalModuleById(49/*internal/streams/lazy_transform*/));
...
const { isAnyArrayBuffer, isArrayBufferView } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 144/*node:util/types*/) || __intrinsic__createInternalModuleById(144/*node:util/types*/));
...

{
  ...
  __intrinsic__toClass(Cipheriv, "Cipheriv", LazyTransform);
  ...
  __intrinsic__toClass(Decipheriv, "Decipheriv", LazyTransform);
