...
const { throwNotImplemented, warnNotImplementedOnce } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32/*internal/shared*/) || __intrinsic__createInternalModuleById(32/*internal/shared*/));
...
class Worker extends EventEmitter {
  ...
  terminate(callback: unknown) {
    ...
    if (onExitPromise) {
      return __intrinsic__isPromise(onExitPromise) ? onExitPromise : Promise.__intrinsic__resolve(onExitPromise);
    }
