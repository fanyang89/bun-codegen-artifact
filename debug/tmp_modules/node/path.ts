...
const [bindingPosix, bindingWin32] = __intrinsic__lazy(73);
...
function matchesGlob(isWindows, path, pattern) {
  ...
  if (prevGlob) {
    !(IS_BUN_DEVELOPMENT?$assert(prevPattern !== undefined,"prevPattern !== undefined"):void 0);
...
$ = (process.platform === "win32" ? win32 : posix) as any as typeof import("node:path");
;$$EXPORT$$($).$$EXPORT_END$$;
