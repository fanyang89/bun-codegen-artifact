...
var tmpdir = function () {
  ...
  tmpdir = function () {
    if (process.platform === "win32") {
      ...
      if (path.length > 1 && path[path.length - 1] === "\\" && !String.prototype.endsWith.__intrinsic__call(path, ":\\")) {
        path = String.prototype.slice.__intrinsic__call(path, 0, -1);
      }
      return path;
    }
  ...
  return {
    ...
    endianness: function () {
      return process.arch === "arm64" || process.arch === "x64" //
        ? "LE"
        : __intrinsic__bundleError("TODO: endianness");
    },
      ...
      return process.platform === "win32"
        ...
        : process.platform === "darwin"
          ...
          : process.platform === "linux"
            ? "Linux"
            : __intrinsic__bundleError("TODO: type");
    },
    ...
    machine: function () {
      return process.arch === "arm64" //
        ...
        : process.arch === "x64"
          ? "x86_64"
          : __intrinsic__bundleError("TODO: machine");
    },
...
const out = bound(__intrinsic__lazy(72));
...
function symbolToStringify(obj, key) {
  !(IS_BUN_DEVELOPMENT?$assert(obj[key] !== undefined,"obj[key] !== undefined", `Missing ${key}`):void 0);
