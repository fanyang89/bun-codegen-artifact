...
// Sourced from src/js/node/test.ts
...
const { jest } = Bun;
const { kEmptyObject, throwNotImplemented } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32/*internal/shared*/) || __intrinsic__createInternalModuleById(32/*internal/shared*/));
...
const assert = {
  ...(__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 85/*node:assert*/) || __intrinsic__createInternalModuleById(85/*node:assert*/)),
  fileSnapshot,
  snapshot,
  // register,
};
