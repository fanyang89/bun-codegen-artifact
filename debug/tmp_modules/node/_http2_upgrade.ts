...
// Sourced from src/js/node/_http2_upgrade.ts


const { Duplex } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 117/*node:stream*/) || __intrinsic__createInternalModuleById(117/*node:stream*/));
...
interface NativeHandle {
  ...
  __intrinsic__write(chunk: Buffer, encoding: string): boolean;
  alpnProtocol?: string;
}
...
function socketHandshake(
  ...
  ctx.connectionListener.__intrinsic__call(ctx.server, tlsSocket);
