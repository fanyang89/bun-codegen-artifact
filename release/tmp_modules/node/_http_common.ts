...
// Sourced from src/js/node/_http_common.ts


const { checkIsHttpToken } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68/*internal/validators*/) || __intrinsic__createInternalModuleById(68/*internal/validators*/));
const FreeList = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 19/*internal/freelist*/) || __intrinsic__createInternalModuleById(19/*internal/freelist*/));
const { methods, allMethods, HTTPParser } = process.binding("http_parser");
const incoming = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 74/*node:_http_incoming*/) || __intrinsic__createInternalModuleById(74/*node:_http_incoming*/));
