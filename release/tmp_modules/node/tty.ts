...
// Sourced from src/js/node/tty.ts
...
const fs = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 23/*internal/fs/streams*/) || __intrinsic__createInternalModuleById(23/*internal/fs/streams*/));
  ...
  get() {
    ...
    Prototype.setRawMode = function (flag) {
      ...
      if (process.platform === "win32") {
        ...
        const handle = this.__intrinsic__bunNativePtr;
        if (!handle) {
...
Object.defineProperty(WriteStream, "prototype", {
  get() {
    ...
    WriteStream.prototype.clearLine = function (dir, cb) {
      return (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 113/*node:readline*/) || __intrinsic__createInternalModuleById(113/*node:readline*/)).clearLine(this, dir, cb);
    };

    WriteStream.prototype.clearScreenDown = function (cb) {
      return (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 113/*node:readline*/) || __intrinsic__createInternalModuleById(113/*node:readline*/)).clearScreenDown(this, cb);
    };

    WriteStream.prototype.cursorTo = function (x, y, cb) {
      return (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 113/*node:readline*/) || __intrinsic__createInternalModuleById(113/*node:readline*/)).cursorTo(this, x, y, cb);
    };
    ...
    WriteStream.prototype.getColorDepth = function (env = process.env) {
      return (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 62/*internal/tty*/) || __intrinsic__createInternalModuleById(62/*internal/tty*/)).getColorDepth(env);
    };
    ...
    WriteStream.prototype.moveCursor = function (dx, dy, cb) {
      return (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 113/*node:readline*/) || __intrinsic__createInternalModuleById(113/*node:readline*/)).moveCursor(this, dx, dy, cb);
    };
