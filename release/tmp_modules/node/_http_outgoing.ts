...
// Sourced from src/js/node/_http_outgoing.ts


const { Stream } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 40/*internal/stream*/) || __intrinsic__createInternalModuleById(40/*internal/stream*/));
const { isUint8Array, validateString } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68/*internal/validators*/) || __intrinsic__createInternalModuleById(68/*internal/validators*/));
