...
const fs = __intrinsic__lazy(53) as __intrinsic__ZigGeneratedClasses.NodeJSFS;
const { glob } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 22/*internal/fs/glob*/) || __intrinsic__createInternalModuleById(22/*internal/fs/glob*/));
...
var PromisePrototypeFinally = __intrinsic__Promise.prototype.finally; //TODO
...
function cp(src, dest, options) {
  ...
  if (options.dereference || options.filter || options.preserveTimestamps || options.verbatimSymlinks) {
    return (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 21/*internal/fs/cp*/) || __intrinsic__createInternalModuleById(21/*internal/fs/cp*/))(src, dest, options);
  }
...
async function opendir(dir: string, options) {
  return new ((__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 98/*node:fs*/) || __intrinsic__createInternalModuleById(98/*node:fs*/)).Dir)(1, dir, options);
}
...
const exports = {
  ...
  writeFile: async function (fileHandleOrFdOrPath, ...args: any[]) {
    fileHandleOrFdOrPath = fileHandleOrFdOrPath?.[kFd] ?? fileHandleOrFdOrPath;
    if (
      !__intrinsic__isTypedArrayView(args[0]) &&
      typeof args[0] !== "string" &&
      (__intrinsic__isCallable(args[0]?.[Symbol.iterator]) || __intrinsic__isCallable(args[0]?.[Symbol.asyncIterator]))
    ) {
      (IS_BUN_DEVELOPMENT?$debug_log("fs.promises.writeFile async iterator slow path!"):void 0);
...

{
  ...
  class FileHandle extends EventEmitter {
    ...
    readLines(options = undefined) {
      if (Interface === undefined) Interface = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 113/*node:readline*/) || __intrinsic__createInternalModuleById(113/*node:readline*/)).Interface;
    ...
    async write(buffer, offset, length, position) {
      ...
      isArrayBufferView ??= (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 144/*node:util/types*/) || __intrinsic__createInternalModuleById(144/*node:util/types*/)).isArrayBufferView;
    ...
    async close() {
      ...
      if (--this[kRefs] === 0) {
        ...
        this[kClosePromise] = PromisePrototypeFinally.__intrinsic__call(
    ...
    createReadStream(options = kEmptyObject) {
      ...
      return new ((__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 23/*internal/fs/streams*/) || __intrinsic__createInternalModuleById(23/*internal/fs/streams*/)).ReadStream)(undefined, {
    ...
    createWriteStream(options = kEmptyObject) {
      ...
      return new ((__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 23/*internal/fs/streams*/) || __intrinsic__createInternalModuleById(23/*internal/fs/streams*/)).WriteStream)(undefined, {
        highWaterMark: 64 * 1024,
        ...options,
        fd: this,
      });
  ...
  try {
    for await (let chunk of iterable) {
      ...
      if (mustRencode && typeof chunk === "string") {
        (IS_BUN_DEVELOPMENT?$debug_log("Re-encoding chunk to", encoding):void 0);
