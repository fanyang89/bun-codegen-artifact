...
// Sourced from src/js/node/fs.ts
...
const promises = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 97/*node:fs/promises*/) || __intrinsic__createInternalModuleById(97/*node:fs/promises*/));
...
const { validateFunction, validateInteger } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68/*internal/validators*/) || __intrinsic__createInternalModuleById(68/*internal/validators*/));
...
const { fs } = promises.__intrinsic__data;

const constants = __intrinsic__processBindingConstants.fs;
var _lazyGlob;
function lazyGlob() {
  return (_lazyGlob ??= (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 22/*internal/fs/glob*/) || __intrinsic__createInternalModuleById(22/*internal/fs/glob*/)));
}
...
function nullcallback(callback) {
  return FunctionPrototypeBind.__intrinsic__call(callback, undefined, null);
}
...
function openAsBlob(path, options) {
  return Promise.__intrinsic__resolve(Bun.file(path, options));
}
...
const { defineCustomPromisifyArgs } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 31/*internal/promisify*/) || __intrinsic__createInternalModuleById(31/*internal/promisify*/));
...
function getValidatedPath(p: any) {
  ...
  if (typeof p !== "string") throw __intrinsic__makeErrorWithCode(118, "path", "string or URL", p);
  if (p.startsWith("file:")) return Bun.fileURLToPath(p);
  return (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 107/*node:path*/) || __intrinsic__createInternalModuleById(107/*node:path*/)).resolve(p);
}
...
function nextPartWindows(p, i) {
  for (; i < p.length; ++i) {
    const ch = p.__intrinsic__charCodeAt(i);
  ...
  process.platform !== "win32"
    ...
    : function realpathSync(p, options) {
        ...
        if (options) {
          ...
          if (encoding) {
            (assertEncodingForWindows ?? __intrinsic__lazy(54))(
              encoding,
            );
          }
        }
        ...
        if (p instanceof URL) {
          if (p.pathname.indexOf("%00") != -1) {
            throw __intrinsic__makeErrorWithCode(119, "path", "string without null bytes", p.pathname);
          }
        ...
        knownHard.__intrinsic__add(base);

        const pathModule = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 107/*node:path*/) || __intrinsic__createInternalModuleById(107/*node:path*/));
        ...
        while (pos < p.length) {
          ...
          if (knownHard.__intrinsic__has(base)) {
...
function cpSync(src, dest, options) {
  ...
  if (options.dereference || options.filter || options.preserveTimestamps || options.verbatimSymlinks) {
    return (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 20/*internal/fs/cp-sync*/) || __intrinsic__createInternalModuleById(20/*internal/fs/cp-sync*/))(src, dest, options);
  }
...
class Dir {
  ...
  constructor(handle, path: PathLike, options) {
    if (__intrinsic__isUndefinedOrNull(handle)) throw __intrinsic__makeErrorWithCode(150, "handle");
  ...
  readSync() {
    if (this.#handle < 0) throw __intrinsic__makeErrorWithCode(52, );
  ...
  read(cb?: (err: Error | null, entry: DirentType) => void): any {
    ...
    if (this.#entries) return Promise.__intrinsic__resolve(this.#entries.shift() ?? null);
  ...
  close(cb?: () => void) {
    ...
    if (handle < 0) throw __intrinsic__makeErrorWithCode(52, );
    if (!__intrinsic__isUndefinedOrNull(cb)) {
      validateFunction(cb, "callback");
      process.nextTick(cb);
    }
...
var exports = {
  ...
  Stats,
  get ReadStream() {
    return (exports.ReadStream = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 23/*internal/fs/streams*/) || __intrinsic__createInternalModuleById(23/*internal/fs/streams*/)).ReadStream);
  },
  ...
  get WriteStream() {
    return (exports.WriteStream = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 23/*internal/fs/streams*/) || __intrinsic__createInternalModuleById(23/*internal/fs/streams*/)).WriteStream);
  },
  ...
  get FileReadStream() {
    return (exports.FileReadStream = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 23/*internal/fs/streams*/) || __intrinsic__createInternalModuleById(23/*internal/fs/streams*/)).ReadStream);
  },
  ...
  get FileWriteStream() {
    return (exports.FileWriteStream = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 23/*internal/fs/streams*/) || __intrinsic__createInternalModuleById(23/*internal/fs/streams*/)).WriteStream);
  },
