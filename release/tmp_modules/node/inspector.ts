...
const startCPUProfiler = __intrinsic__lazy(57);
const stopCPUProfiler = __intrinsic__lazy(58);
const setCPUSamplingInterval = __intrinsic__lazy(59);
const isCPUProfilerRunning = __intrinsic__lazy(60);
