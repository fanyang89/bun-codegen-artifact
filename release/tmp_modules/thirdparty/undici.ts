...
const StreamModule = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 117/*node:stream*/) || __intrinsic__createInternalModuleById(117/*node:stream*/));
const { Readable } = StreamModule;
const { _ReadableFromWeb: ReadableFromWeb } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 69/*internal/webstreams_adapters*/) || __intrinsic__createInternalModuleById(69/*internal/webstreams_adapters*/));

const ObjectCreate = Object.create;
const kEmptyObject = ObjectCreate(null);

var fetch = Bun.fetch;
const bindings = __intrinsic__lazy(96);
