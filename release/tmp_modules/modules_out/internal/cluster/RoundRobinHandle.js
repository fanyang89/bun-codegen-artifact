// @bun
// build/release/tmp_modules/internal/cluster/RoundRobinHandle.ts
var $, { append, init, isEmpty, peek, remove } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 27) || __intrinsic__createInternalModuleById(27), { kHandle } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32) || __intrinsic__createInternalModuleById(32), net, sendHelper = __intrinsic__lazy(3), ArrayIsArray = __intrinsic__Array.isArray;
var assert_fail = () => {
...
$ = class RoundRobinHandle {
  ...
  constructor(key, address, { port, fd, flags, backlog, readableAll, writableAll }) {
    if (net ??= __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 104) || __intrinsic__createInternalModuleById(104), this.key = key, this.all = /* @__PURE__ */ new Map, this.free = /* @__PURE__ */ new Map, this.handles = init(Object.create(null)), this.handle = null, this.server = net.createServer(assert_fail), fd >= 0)
