// @bun
// build/release/tmp_modules/internal/sql/errors.ts
var $;
...
class PostgresError extends SQLError {
  ...
  constructor(message, options) {
    super(message);
    if (this.name = "PostgresError", this.code = options.code, options.errno !== __intrinsic__undefined)
...
class SQLiteError extends SQLError {
  ...
  constructor(message, options) {
    super(message);
    if (this.name = "SQLiteError", this.code = options.code, this.errno = options.errno, options.byteOffset !== __intrinsic__undefined)
...
class MySQLError extends SQLError {
  ...
  constructor(message, options) {
    super(message);
    if (this.name = "MySQLError", this.code = options.code, options.errno !== __intrinsic__undefined)
      this.errno = options.errno;
