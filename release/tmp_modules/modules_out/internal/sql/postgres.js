// @bun
// build/release/tmp_modules/internal/sql/postgres.ts
var $, {
  SQLHelper,
  SSLMode,
  SQLResultArray,
...
var { PostgresError } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 33) || __intrinsic__createInternalModuleById(33), {
  ...
  init: initPostgres
} = __intrinsic__lazy(17), cmds = ["", "INSERT", "DELETE", "UPDATE", "MERGE", "SELECT", "MOVE", "FETCH", "COPY"], escapeBackslash = /\\/g, escapeQuote = /"/g;
...
class PostgresAdapter {
  ...
  constructor(connectionInfo) {
    this.connectionInfo = connectionInfo, this.connections = new __intrinsic__Array(connectionInfo.max), this.readyConnections = /* @__PURE__ */ new Set;
  }
