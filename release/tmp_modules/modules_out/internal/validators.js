// @bun
// build/release/tmp_modules/internal/validators.ts
var $, { hideFromStack } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32) || __intrinsic__createInternalModuleById(32), RegExpPrototypeExec = __intrinsic__RegExp.prototype.exec, ArrayIsArray = __intrinsic__Array.isArray, ObjectPrototypeHasOwnProperty = Object.prototype.hasOwnProperty, tokenRegExp = /^[\^_`a-zA-Z\-0-9!#$%&'*+.|~]+$/;
function checkIsHttpToken(val) {
  return RegExpPrototypeExec.__intrinsic__call(tokenRegExp, val) !== null;
}
var linkValueRegExp = /^(?:<[^>]*>)(?:\s*;\s*[^;"\s]+(?:=(")?[^;"\s]*\1)?)*$/;
function validateLinkHeaderFormat(value, name) {
  if (typeof value > "u" || !RegExpPrototypeExec.__intrinsic__call(linkValueRegExp, value))
