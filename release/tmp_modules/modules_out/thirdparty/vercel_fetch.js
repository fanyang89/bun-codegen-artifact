// @bun
// build/release/tmp_modules/thirdparty/vercel_fetch.ts
var $;
$ = (wrapper = Bun.fetch) => {
  async function vercelFetch(url, opts = {}) {
    if (opts.body && typeof opts.body === "object" && (!("buffer" in opts.body) || typeof opts.body.buffer !== "object" || !(opts.body.buffer instanceof __intrinsic__ArrayBuffer))) {
