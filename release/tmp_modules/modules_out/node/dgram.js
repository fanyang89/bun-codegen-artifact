// @bun
// build/release/tmp_modules/node/dgram.ts
var $;
var kStateSymbol = Symbol("state symbol"), kOwnerSymbol = Symbol("owner symbol"), async_id_symbol = Symbol("async_id_symbol"), { throwNotImplemented } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32) || __intrinsic__createInternalModuleById(32), {
  validateString,
  validateNumber,
  validateFunction,
  validatePort,
  validateAbortSignal
} = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68) || __intrinsic__createInternalModuleById(68), { isIP } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 28) || __intrinsic__createInternalModuleById(28), EventEmitter = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 96) || __intrinsic__createInternalModuleById(96), { deprecate } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 65) || __intrinsic__createInternalModuleById(65), SymbolDispose = Symbol.dispose, SymbolAsyncDispose = Symbol.asyncDispose, ObjectDefineProperty = Object.defineProperty, FunctionPrototypeBind = Function.prototype.bind;
...
function Socket(type, listener) {
  ...
  if (this[kStateSymbol] = {
    ...
    sendBufferSize,
    unrefOnBind: !1
  }, options?.signal !== __intrinsic__undefined) {
    let { signal } = options;
...
Socket.prototype.bind = function(port_, address_) {
  ...
  if (typeof cb === "function") {
    let removeListeners2 = function() {
      ...
      removeListeners2.__intrinsic__call(this), cb.__intrinsic__call(this);
    };
...
Socket.prototype.disconnect = function() {
  ...
  disconnectFn.__intrinsic__call(state.handle.socket), state.connectState = 0;
};
...
function fixBufferList(list) {
  let newlist = new __intrinsic__Array(list.length);
...
function onListenSuccess() {
  this.removeListener(EventEmitter.errorMonitor, onListenError), clearQueue.__intrinsic__call(this);
}
function onListenError(_err) {
  this.removeListener("listening", onListenSuccess), this[kStateSymbol].queue = __intrinsic__undefined;
}
function clearQueue() {
...
Socket.prototype.send = function(buffer, offset, length, port, address, callback) {
  ...
  if (typeof address === "function")
    callback = address, address = __intrinsic__undefined;
...
Socket.prototype.close = function(callback) {
  ...
  if (queue !== __intrinsic__undefined)
    return queue.push(FunctionPrototypeBind.__intrinsic__call(this.close, this)), this;
