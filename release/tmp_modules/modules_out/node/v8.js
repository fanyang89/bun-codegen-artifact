// @bun
// build/release/tmp_modules/node/v8.ts
var $, { hideFromStack, throwNotImplemented } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32) || __intrinsic__createInternalModuleById(32), jsc = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 139) || __intrinsic__createInternalModuleById(139);
...
function getHeapSnapshot() {
  if (!HeapSnapshotReadable_) {
    let Readable = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 117) || __intrinsic__createInternalModuleById(117)).Readable;
