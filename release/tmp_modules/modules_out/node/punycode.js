// @bun
// build/release/tmp_modules/node/punycode.ts
...
}, baseMinusTMin = base - tMin, floor = Math.floor, stringFromCharCode = __intrinsic__String.fromCharCode;
function error(type) {
...
var ucs2encode = (codePoints) => __intrinsic__String.fromCodePoint(...codePoints), basicToDigit = function(codePoint) {
  ...
  return __intrinsic__String.fromCodePoint(...output);
