// @bun
// build/release/tmp_modules/node/http2.ts
var $, { isTypedArray } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 144) || __intrinsic__createInternalModuleById(144), { hideFromStack, throwNotImplemented } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32) || __intrinsic__createInternalModuleById(32), { STATUS_CODES } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 25) || __intrinsic__createInternalModuleById(25), tls = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 122) || __intrinsic__createInternalModuleById(122), net = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 104) || __intrinsic__createInternalModuleById(104), fs = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 98) || __intrinsic__createInternalModuleById(98), { __intrinsic__data } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 97) || __intrinsic__createInternalModuleById(97), FileHandle = __intrinsic__data.FileHandle;
...
var Stream = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 117) || __intrinsic__createInternalModuleById(117), { Readable } = Stream, TLSSocket = tls.TLSSocket, Socket = net.Socket, EventEmitter = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 96) || __intrinsic__createInternalModuleById(96), { Duplex } = Stream, { SafeArrayIterator, SafeSet } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 30) || __intrinsic__createInternalModuleById(30), { promisify } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 31) || __intrinsic__createInternalModuleById(31), RegExpPrototypeExec = __intrinsic__RegExp.prototype.exec, ObjectAssign = Object.assign, ArrayIsArray = __intrinsic__Array.isArray, ObjectKeys = Object.keys, FunctionPrototypeBind = Function.prototype.bind, StringPrototypeTrim = __intrinsic__String.prototype.trim, ArrayPrototypePush = __intrinsic__Array.prototype.push, StringPrototypeToLowerCase = __intrinsic__String.prototype.toLowerCase, StringPrototypeIncludes = __intrinsic__String.prototype.includes, StringPrototypeStartsWith = __intrinsic__String.prototype.startsWith, ObjectPrototypeHasOwnProperty = Object.prototype.hasOwnProperty, DatePrototypeToUTCString = Date.prototype.toUTCString, DatePrototypeGetMilliseconds = Date.prototype.getMilliseconds, H2FrameParser = __intrinsic__lazy(55), _nativeAssertSettings = __intrinsic__lazy(56), { upgradeRawSocketToH2 } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 70) || __intrinsic__createInternalModuleById(70);
var kSettingIds = {
  1: "headerTableSize",
  2: "enablePush",
...
function getPackedSettings(settings) {
  if (settings === __intrinsic__undefined)
  ...
  else if (settings.maxHeaderSize !== __intrinsic__undefined)
  ...
  let buf = __intrinsic__Buffer.alloc(entries.length * 6);
...
function getUnpackedSettings(buf, options) {
  if (buf === __intrinsic__undefined)
    return { ...kDefaultSettings };
  if (!__intrinsic__Buffer.isBuffer(buf) && !isTypedArray(buf))
    throw __intrinsic__makeErrorWithCode(118, "buf", ["Buffer", "TypedArray"], buf);
  if (buf.length % 6 !== 0) {
  ...
  for (let i = 0;i < buf.length; i += 6) {
    ...
    if (name) {
      ...
      customSettings[__intrinsic__String(type)] = value, hasCustom = !0;
  }
  if (hasCustom)
...
var sensitiveHeaders = Symbol.for("nodejs.http2.sensitiveHeaders"), bunHTTP2Native = Symbol.for("::bunhttp2native::"), bunHTTP2Socket = Symbol.for("::bunhttp2socket::"), bunHTTP2OriginSet = Symbol("::bunhttp2originset::"), bunHTTP2StreamFinal = Symbol.for("::bunHTTP2StreamFinal::"), bunHTTP2StreamStatus = Symbol.for("::bunhttp2StreamStatus::"), bunHTTP2Session = Symbol.for("::bunhttp2session::"), bunHTTP2Headers = Symbol.for("::bunhttp2headers::"), ReflectGetPrototypeOf = Reflect.getPrototypeOf, kBeginSend = Symbol("begin-send"), kServer = Symbol("server"), kState = Symbol("state"), kStream = Symbol("stream"), kResponse = Symbol("response"), kHeaders = Symbol("headers"), kRawHeaders = Symbol("rawHeaders"), kTrailers = Symbol("trailers"), kRawTrailers = Symbol("rawTrailers"), kSetHeader = Symbol("setHeader"), kAppendHeader = Symbol("appendHeader"), kAborted = Symbol("aborted"), kRequest = Symbol("request"), kHeadRequest = Symbol("headRequest"), kMaxStreams = 4294967295, kMaxInt = 4294967295, kMaxWindowSize = 2147483647, {
  ...
  validateBuffer,
  validateNumber
} = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68) || __intrinsic__createInternalModuleById(68), utcCache;
function utcDate() {
  if (!utcCache)
    cache();
  return utcCache;
...
function emitOutofStreamErrorNT(self) {
  self.destroy(__intrinsic__makeErrorWithCode(94));
}
function cache() {
...
function resetCache() {
  utcCache = __intrinsic__undefined;
}
function getAuthority(headers) {
  if (headers[HTTP2_HEADER_AUTHORITY] !== __intrinsic__undefined)
    return headers[HTTP2_HEADER_AUTHORITY];
  if (headers[HTTP2_HEADER_HOST] !== __intrinsic__undefined)
    return headers[HTTP2_HEADER_HOST];
}
function onStreamData(chunk) {
  let request = this[kRequest];
  if (request !== __intrinsic__undefined && !request.push(chunk))
    this.pause();
}
function onStreamTrailers(trailers, flags, rawTrailers) {
  let request = this[kRequest];
  if (request !== __intrinsic__undefined)
    ObjectAssign(request[kTrailers], trailers), ArrayPrototypePush.__intrinsic__call(request[kRawTrailers], ...new SafeArrayIterator(rawTrailers));
}
function onStreamEnd() {
  if (this[kRequest] !== __intrinsic__undefined)
...
function onStreamDrain() {
  ...
  if (response !== __intrinsic__undefined)
    response.emit("drain");
}
function onStreamAbortedResponse() {}
function onStreamAbortedRequest() {
  let request = this[kRequest];
  if (request !== __intrinsic__undefined && request[kState].closed === !1)
...
function onStreamCloseResponse() {
  ...
  if (res === __intrinsic__undefined)
    return;
  let state = res[kState];
  if (this.headRequest !== state.headRequest)
    return;
  state.closed = !0, this.removeListener("wantTrailers", onStreamTrailersReady), this[kResponse] = __intrinsic__undefined, res.emit("finish"), res.emit("close");
}
function onStreamCloseRequest() {
  let req = this[kRequest];
  if (req === __intrinsic__undefined)
    return;
  let state = req[kState];
  if (state.closed = !0, req.push(null), !state.didRead && !req._readableState.resumeScheduled)
    req.resume();
  this[kRequest] = __intrinsic__undefined, req.emit("close");
}
...
function assertValidHeader(name, value) {
  if (name === "" || typeof name !== "string" || StringPrototypeIncludes.__intrinsic__call(name, " "))
    throw __intrinsic__makeErrorWithCode(127, "Header name", name);
  if (isPseudoHeader(name))
    throw __intrinsic__makeErrorWithCode(98);
  if (value === __intrinsic__undefined || value === null)
    throw __intrinsic__makeErrorWithCode(85, value, name);
  if (!isConnectionHeaderAllowed(name, value))
    connectionHeaderMessageWarn();
}
function assertIsObject(value, name, types) {
  if (value !== __intrinsic__undefined && (!__intrinsic__isObject(value) || __intrinsic__isArray(value)))
    throw __intrinsic__makeErrorWithCode(118, name, types || "Object", value);
}
function assertIsArray(value, name, types) {
  if (value !== __intrinsic__undefined && !__intrinsic__isArray(value))
    throw __intrinsic__makeErrorWithCode(118, name, types || "Array", value);
}
...
class Http2ServerRequest extends Readable {
  ...
  set method(method) {
    if (validateString(method, "method"), StringPrototypeTrim.__intrinsic__call(method) === "")
      throw __intrinsic__makeErrorWithCode(119, "method", method);
...
class Http2ServerResponse extends Stream {
  ...
  set statusCode(code) {
    if (code |= 0, code >= 100 && code < 200)
      throw __intrinsic__makeErrorWithCode(84);
    if (code < 100 || code > 599)
      throw __intrinsic__makeErrorWithCode(105, code);
    this[kState].statusCode = code;
  }
  setTrailer(name, value) {
    validateString(name, "name"), name = StringPrototypeToLowerCase.__intrinsic__call(StringPrototypeTrim.__intrinsic__call(name)), assertValidHeader(name, value), this[kTrailers][name] = value;
  }
  addTrailers(headers) {
  ...
  getHeader(name) {
    return validateString(name, "name"), name = StringPrototypeToLowerCase.__intrinsic__call(StringPrototypeTrim.__intrinsic__call(name)), this[kHeaders][name];
  }
  getHeaderNames() {
  ...
  hasHeader(name) {
    return validateString(name, "name"), name = StringPrototypeToLowerCase.__intrinsic__call(StringPrototypeTrim.__intrinsic__call(name)), ObjectPrototypeHasOwnProperty.__intrinsic__call(this[kHeaders], name);
  }
  removeHeader(name) {
    if (validateString(name, "name"), this[kStream].headersSent)
      throw __intrinsic__makeErrorWithCode(83);
    if (name = StringPrototypeToLowerCase.__intrinsic__call(StringPrototypeTrim.__intrinsic__call(name)), name === "date") {
  ...
  [kSetHeader](name, value) {
    if (name = StringPrototypeToLowerCase.__intrinsic__call(StringPrototypeTrim.__intrinsic__call(name)), assertValidHeader(name, value), !isConnectionHeaderAllowed(name, value))
      return;
    if (name[0] === ":")
      assertValidPseudoHeader(name);
    else if (!checkIsHttpToken(name))
      this.destroy(__intrinsic__makeErrorWithCode(127, "Header name", name));
  ...
  writeHead(statusCode, statusMessage, headers) {
    ...
    if (typeof statusMessage === "string")
      statusMessageWarn();
    if (headers === __intrinsic__undefined && typeof statusMessage === "object")
    ...
    if (ArrayIsArray(headers)) {
      ...
      if (headers.length && ArrayIsArray(headers[0]))
        ...
        if (headers.length % 2 !== 0)
          throw __intrinsic__makeErrorWithCode(119, "headers", headers);
  ...
  write(chunk, encoding, cb) {
    ...
    if (state.ending)
      ...
      err = __intrinsic__makeErrorWithCode(90);
    ...
    if (chunk !== null && chunk !== __intrinsic__undefined)
    ...
    if (this[kState].closed || stream.destroyed)
      onStreamCloseResponse.__intrinsic__call(stream);
    else
      stream.end();
    return this;
  }
  ...
  createPushResponse(headers, callback) {
    if (validateFunction(callback, "callback"), this[kState].closed) {
      let error = __intrinsic__makeErrorWithCode(90);
...
function onServerStream(Http2ServerRequest2, Http2ServerResponse2, stream, headers, flags, rawHeaders) {
  let server = this, request = new Http2ServerRequest2(stream, headers, __intrinsic__undefined, rawHeaders), response = new Http2ServerResponse2(stream);
  ...
  if (headers.expect !== __intrinsic__undefined) {
...
var proxyCompatSocketHandler = {
  has(stream, prop) {
    let ref = stream.session !== __intrinsic__undefined ? stream.session[bunHTTP2Socket] : stream;
  ...
  get(stream, prop) {
    switch (prop) {
      ...
      case "setTimeout": {
        ...
        if (session !== __intrinsic__undefined)
      ...
      case "pause":
      case "resume":
        throw __intrinsic__makeErrorWithCode(92);
      default: {
        let ref = stream.session !== __intrinsic__undefined ? stream.session[bunHTTP2Socket] : stream, value = ref[prop];
        return typeof value === "function" ? value.bind(ref) : value;
      }
    }
  },
  getPrototypeOf(stream) {
    if (stream.session !== __intrinsic__undefined)
  ...
  get(session, prop) {
    switch (prop) {
      ...
      case "ref":
      case "unref":
        return FunctionPrototypeBind.__intrinsic__call(session[prop], session);
      case "destroy":
      case "emit":
      case "end":
      case "pause":
      ...
      default: {
        ...
        if (!socket)
          throw __intrinsic__makeErrorWithCode(103);
        let value = socket[prop];
        return typeof value === "function" ? FunctionPrototypeBind.__intrinsic__call(value, socket) : value;
      }
    }
  },
...
function assertValidPseudoHeader(key) {
  if (!kValidPseudoHeaders.has(key))
    throw __intrinsic__makeErrorWithCode(88, key);
}
...
class Http2Session extends EventEmitter {
  [bunHTTP2Socket];
  [bunHTTP2OriginSet] = __intrinsic__undefined;
...
function streamErrorFromCode(code) {
  if (code === 14)
    return __intrinsic__makeErrorWithCode(91);
  return __intrinsic__makeErrorWithCode(106, nameForErrorCode[code] || code);
}
hideFromStack(streamErrorFromCode);
function sessionErrorFromCode(code) {
  if (code === 14)
    return __intrinsic__makeErrorWithCode(91);
  return __intrinsic__makeErrorWithCode(102, nameForErrorCode[code] || code);
}
hideFromStack(sessionErrorFromCode);
function assertSession(session) {
  if (!session)
    throw __intrinsic__makeErrorWithCode(89);
}
...
class Http2Stream extends Duplex {
  ...
  rstCode = __intrinsic__undefined;
  [bunHTTP2Headers];
  [kInfoHeaders];
  #sentTrailers;
  [kAborted] = !1;
  ...
  sendTrailers(headers) {
    ...
    if (this.destroyed || this.closed)
      throw __intrinsic__makeErrorWithCode(90);
    if (this.#sentTrailers)
      throw __intrinsic__makeErrorWithCode(107);
    if (assertSession(session), (this[bunHTTP2StreamStatus] & 2 /* WantTrailer */) === 0)
      throw __intrinsic__makeErrorWithCode(108);
    if (headers == __intrinsic__undefined)
      headers = {};
    else if (!__intrinsic__isObject(headers))
      throw __intrinsic__makeErrorWithCode(118, "headers", "object", headers);
    else
      headers = { ...headers };
    let sensitives = headers[sensitiveHeaders], sensitiveNames = {};
    if (delete headers[sensitiveHeaders], sensitives) {
      if (!__intrinsic__isJSArray(sensitives))
        throw __intrinsic__makeErrorWithCode(119, "headers[http2.neverIndex]", sensitives);
  ...
  _destroy(err, callback) {
    ...
    if (this.rstCode = rstCode, err == null && rstCode !== NGHTTP2_NO_ERROR && rstCode !== NGHTTP2_CANCEL)
      err = __intrinsic__makeErrorWithCode(106, nameForErrorCode[rstCode] || rstCode);
  ...
  _read(_size) {}
    ...
    if (typeof callback > "u") {
      if (typeof chunk === "function")
        callback = chunk, chunk = __intrinsic__undefined;
      else if (typeof encoding === "function")
  ...
  _writev(data, callback) {
    ...
    if (session) {
      ...
      if (native) {
        ...
        let chunk = __intrinsic__Buffer.concat(chunks || []);
        native.writeStream(this.#id, chunk, __intrinsic__undefined, !1, callback);
        return;
      }
    }
...
function doSendFileFD(options, fd, headers, err, stat) {
  ...
  if (!stat.isFile()) {
    ...
    if (options.offset !== __intrinsic__undefined || options.offset > 0 || options.length !== __intrinsic__undefined || options.length >= 0 || isDirectory) {
      let err2 = isDirectory ? __intrinsic__makeErrorWithCode(101) : __intrinsic__makeErrorWithCode(100);
  ...
  if (this.destroyed || this.closed) {
    tryClose(fd), this.destroy(__intrinsic__makeErrorWithCode(90));
    return;
  }
  let statOptions = {
    offset: options.offset !== __intrinsic__undefined ? options.offset : 0,
    length: options.length !== __intrinsic__undefined ? options.length : -1
  };
  ...
  if (statOptions.length <= 0)
    if (stat.isFile())
      ...
      statOptions.length = __intrinsic__undefined;
  if (typeof options.statCheck === "function" && options.statCheck.__intrinsic__call(this, stat, headers, options) === !1 || this.headersSent) {
    tryClose(fd);
    return;
  }
  if (stat.isFile()) {
  ...
  try {
    this.respond(headers, options), fs.createReadStream(null, {
      fd,
      autoClose: !1,
      start: statOptions.offset ? statOptions.offset : __intrinsic__undefined,
      end: typeof statOptions.length === "number" ? statOptions.length + (statOptions.offset || 0) - 1 : __intrinsic__undefined,
      emitClose: !1
    }).pipe(this);
  } catch (err2) {
...
class ServerHttp2Stream extends Http2Stream {
  ...
  pushStream() {
    throw __intrinsic__makeErrorWithCode(99);
  }
  respondWithFile(path, headers, options) {
    ...
    if (headers == __intrinsic__undefined)
      ...
      headers = { ...headers };
    if (headers[HTTP2_HEADER_STATUS] === __intrinsic__undefined)
    ...
    if (options = { ...options }, statusCode === HTTP_STATUS_NO_CONTENT || statusCode === HTTP_STATUS_RESET_CONTENT || statusCode === HTTP_STATUS_NOT_MODIFIED || this.headRequest)
      throw __intrinsic__makeErrorWithCode(95, statusCode);
    if (options.offset !== __intrinsic__undefined && typeof options.offset !== "number")
      throw __intrinsic__makeErrorWithCode(119, "options.offset", options.offset);
    if (options.length !== __intrinsic__undefined && typeof options.length !== "number")
      throw __intrinsic__makeErrorWithCode(119, "options.length", options.length);
    if (options.statCheck !== __intrinsic__undefined && typeof options.statCheck !== "function")
      throw __intrinsic__makeErrorWithCode(119, "options.statCheck", options.statCheck);
  ...
  respondWithFD(fd, headers, options) {
    ...
    if (statusCode === HTTP_STATUS_NO_CONTENT || statusCode === HTTP_STATUS_RESET_CONTENT || statusCode === HTTP_STATUS_NOT_MODIFIED || this.headRequest)
      throw __intrinsic__makeErrorWithCode(95, statusCode);
    if (options = { ...options }, options.offset !== __intrinsic__undefined && typeof options.offset !== "number")
      throw __intrinsic__makeErrorWithCode(119, "options.offset", options.offset);
    if (options.length !== __intrinsic__undefined && typeof options.length !== "number")
      throw __intrinsic__makeErrorWithCode(119, "options.length", options.length);
    if (options.statCheck !== __intrinsic__undefined && typeof options.statCheck !== "function")
  ...
  additionalHeaders(headers) {
    ...
    if (this.sentTrailers)
      throw __intrinsic__makeErrorWithCode(107);
    if (this.headersSent)
      throw __intrinsic__makeErrorWithCode(82);
    if (headers == __intrinsic__undefined)
      headers = {};
    else if (!__intrinsic__isObject(headers))
      throw __intrinsic__makeErrorWithCode(118, "headers", "object", headers);
    ...
    for (let name in headers)
      if (name.startsWith(":") && name !== HTTP2_HEADER_STATUS)
        throw __intrinsic__makeErrorWithCode(88, name);
    let sensitives = headers[sensitiveHeaders];
    delete headers[sensitiveHeaders];
    let sensitiveNames = {};
    if (sensitives) {
      if (!__intrinsic__isArray(sensitives))
        throw __intrinsic__makeErrorWithCode(119, "headers[http2.neverIndex]", sensitives);
      for (let i = 0;i < sensitives.length; i++)
        sensitiveNames[sensitives[i]] = !0;
    }
    ...
    if (hasStatus) {
      if (statusCode === HTTP_STATUS_SWITCHING_PROTOCOLS)
        throw __intrinsic__makeErrorWithCode(104);
      if (statusCode < 100 || statusCode >= 200)
        throw __intrinsic__makeErrorWithCode(86, statusCode);
      if (statusCode === HTTP_STATUS_NO_CONTENT || statusCode === HTTP_STATUS_RESET_CONTENT || statusCode === HTTP_STATUS_NOT_MODIFIED || this.headRequest)
        throw __intrinsic__makeErrorWithCode(95, statusCode);
    }
    let session = this[bunHTTP2Session];
    if (assertSession(session), !this[kInfoHeaders])
      ...
      ArrayPrototypePush.__intrinsic__call(this[kInfoHeaders], headers);
    session[bunHTTP2Native]?.request(this.id, __intrinsic__undefined, headers, sensitiveNames);
  }
  respond(headers, options) {
    ...
    if (typeof options > "u")
      ...
      session[bunHTTP2Native]?.request(this.id, __intrinsic__undefined, headers, sensitiveNames, options);
...
function emitStreamErrorNT(self, stream, error, destroy, destroy_self) {
  if (stream) {
    let error_instance = __intrinsic__undefined;
...
function toHeaderObject(headers, sensitiveHeadersValue) {
  ...
  for (let n = 0;n < headers.length; n += 2) {
    ...
    if (existing === __intrinsic__undefined)
      ...
      switch (name) {
        ...
        case HTTP2_HEADER_SET_COOKIE:
          ArrayPrototypePush.__intrinsic__call(existing, value);
          break;
        default:
          obj[name] = `${existing}, ${value}`;
          break;
...
function getOrigin(origin, isAltSvc) {
  if (typeof origin === "string")
    try {
      ...
      if (isAltSvc)
        throw __intrinsic__makeErrorWithCode(75);
      else
        throw __intrinsic__makeErrorWithCode(141, origin);
    }
  ...
  if (validateString(origin, "origin"), !origin || origin === "null")
    if (isAltSvc)
      ...
      throw __intrinsic__makeErrorWithCode(87);
  return origin;
}
function initOriginSet(session) {
  let originSet = session[bunHTTP2OriginSet];
  if (originSet === __intrinsic__undefined) {
    let socket = session[bunHTTP2Socket];
...
class ServerHttp2Session extends Http2Session {
  ...
  #url;
  #isServer = !1;
  #alpnProtocol = __intrinsic__undefined;
  #localSettings = {
    headerTableSize: 4096,
    enablePush: !0,
  ...
  static #Handlers = {
    ...
    goaway(self, errorCode, lastStreamId, opaqueData) {
      if (!self)
        return;
      if (self.emit("goaway", errorCode, lastStreamId, opaqueData || __intrinsic__Buffer.allocUnsafe(0)), errorCode !== 0)
  ...
  altsvc(alt, originOrStream) {
    ...
    if (typeof originOrStream === "string")
      ...
      if (originOrStream >>> 0 !== originOrStream || originOrStream === 0)
        throw __intrinsic__makeErrorWithCode(156, "originOrStream", "> 0 && < 4294967296", originOrStream);
      stream = originOrStream;
    } else if (originOrStream !== __intrinsic__undefined) {
      if (originOrStream !== null && typeof originOrStream === "object")
        origin = originOrStream.origin;
      if (typeof origin !== "string")
        throw __intrinsic__makeErrorWithCode(118, "originOrStream", ["string", "number", "URL", "object"], originOrStream);
      else if (!origin)
        throw __intrinsic__makeErrorWithCode(75);
      else
    ...
    if (validateString(alt, "alt"), !kQuotedString.test(alt))
      throw __intrinsic__makeErrorWithCode(121, "alt");
    if (origin = origin || "", __intrinsic__Buffer.byteLength(origin) + __intrinsic__Buffer.byteLength(alt) > 16382)
      throw __intrinsic__makeErrorWithCode(76);
  ...
  origin(...origins) {
    ...
    let validOrigins = new __intrinsic__Array(length);
  ...
  get originSet() {
    if (this.encrypted)
      return __intrinsic__Array.from(initOriginSet(this));
  }
  get alpnProtocol() {
  ...
  ping(payload, callback) {
    if (typeof payload === "function")
      callback = payload, payload = __intrinsic__Buffer.alloc(8);
    else
      payload = payload || __intrinsic__Buffer.alloc(8);
    if (!(payload instanceof __intrinsic__Buffer) && !isTypedArray(payload))
      throw __intrinsic__makeErrorWithCode(118, "payload", ["Buffer", "TypedArray"], payload);
    let parser = this.#parser;
    if (!parser)
      return !1;
    if (!this[bunHTTP2Socket])
    ...
    if (typeof callback === "function") {
      if (payload.byteLength !== 8) {
        let error = __intrinsic__makeErrorWithCode(97);
  ...
  settings(settings, callback) {
    if (callback !== __intrinsic__undefined && typeof callback !== "function")
  ...
  destroy(error = NGHTTP2_NO_ERROR, code) {
    ...
    if (typeof error === "number")
      code = error, error = code !== NGHTTP2_NO_ERROR ? __intrinsic__makeErrorWithCode(102, code) : __intrinsic__undefined;
    let socket = this[bunHTTP2Socket];
    if (!this.#connected)
      return;
    if (this.#closed = !0, this.#connected = !1, socket)
      this.goaway(code || constants.NGHTTP2_NO_ERROR, 0, __intrinsic__Buffer.alloc(0)), socket.end();
    let parser = this.#parser;
    if (parser)
...
class ClientHttp2Session extends Http2Session {
  ...
  static #Handlers = {
    ...
    goaway(self, errorCode, lastStreamId, opaqueData) {
      if (!self)
        return;
      if (self.emit("goaway", errorCode, lastStreamId, opaqueData || __intrinsic__Buffer.allocUnsafe(0)), self.closed)
        return;
      self.destroy(__intrinsic__undefined, errorCode);
    },
    end(self, errorCode, lastStreamId, opaqueData) {
      if (!self)
        return;
    ...
    origin(self, origin) {
      ...
      if (self.encrypted) {
        ...
        if (__intrinsic__isArray(origin)) {
  ...
  #onConnect() {
    ...
    if (this.#connected = !0, socket instanceof TLSSocket) {
      if (socket.alpnProtocol !== "h2") {
        socket.end();
        let error = __intrinsic__makeErrorWithCode(80, "h2 is not supported");
        this.emit("error", error);
      }
  ...
  #onClose() {
    let parser = this.#parser, err = this.connecting ? __intrinsic__makeErrorWithCode(220) : null;
    if (parser)
  ...
  setNextStreamID(id) {
    ...
    if (validateNumber(id, "id"), id <= 0 || id > kMaxStreams)
      throw __intrinsic__makeErrorWithCode(156, "id", `> 0 and <= ${kMaxStreams}`, id);
  ...
  constructor(url, options, listener) {
    ...
    if (typeof options === "function")
      listener = options, options = __intrinsic__undefined;
    if (assertIsObject(options, "options"), options = { ...options }, assertIsArray(options.remoteCustomSettings, "options.remoteCustomSettings"), options.remoteCustomSettings) {
      if (options.remoteCustomSettings = [...options.remoteCustomSettings], options.remoteCustomSettings.length > 10)
        throw __intrinsic__makeErrorWithCode(109);
    }
    ...
    switch (protocol) {
      ...
      case "https:":
        break;
      default:
        throw __intrinsic__makeErrorWithCode(111, protocol);
    }
    ...
    if (protocol === "https:" && port === 443 || protocol === "http:" && port === 80) {
      let needsBrackets = StringPrototypeIncludes.__intrinsic__call(host, ":") && !StringPrototypeStartsWith.__intrinsic__call(host, "[");
    ...
    function onConnect() {
      try {
        this.#onConnect(arguments), listener?.__intrinsic__call(this, this);
      } catch (e) {
        this.destroy(e);
      }
    }
  ...
  request(headers, options) {
    try {
      ...
      if (headers[":path"] == __intrinsic__undefined)
        headers[":path"] = "/";
      if (NoPayloadMethods.has(method.toUpperCase()))
        if (!options || !__intrinsic__isObject(options))
          options = { endStream: !0 };
        else
          options = { ...options, endStream: !0 };
      let stream_id = this.#parser.getNextStream();
      if (stream_id < 0) {
        let req2 = new ClientHttp2Stream(__intrinsic__undefined, this, headers);
...
function setupCompat(ev) {
  if (ev === "request") {
    ...
    this.on("stream", FunctionPrototypeBind.__intrinsic__call(onServerStream, this, ServerRequest, ServerResponse));
  }
}
...
function connectionListener(socket) {
  ...
  if (this.emit("session", session), options.origins && __intrinsic__isArray(options.origins))
    try {
...
function initializeOptions(options) {
  ...
  if (options.maxSessionInvalidFrames !== __intrinsic__undefined)
    validateUint32(options.maxSessionInvalidFrames, "maxSessionInvalidFrames");
  if (options.maxSessionRejectedStreams !== __intrinsic__undefined)
    validateUint32(options.maxSessionRejectedStreams, "maxSessionRejectedStreams");
  if (options.unknownProtocolTimeout !== __intrinsic__undefined)
...
Object.defineProperty(connect, promisify.custom, {
  ...
  value: function(authority, options) {
    let { promise, resolve, reject } = __intrinsic__Promise.withResolvers(), server = connect(authority, options, () => {
