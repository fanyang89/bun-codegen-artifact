// @bun
// build/release/tmp_modules/node/readline.ts
var $, EventEmitter = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 96) || __intrinsic__createInternalModuleById(96), { StringDecoder } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 143) || __intrinsic__createInternalModuleById(143), { promisify } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 31) || __intrinsic__createInternalModuleById(31), { SafeStringIterator } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 30) || __intrinsic__createInternalModuleById(30), {
  validateFunction,
  validateAbortSignal,
  validateArray,
  validateString,
  ...
  validateUint32,
  validateNumber
} = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68) || __intrinsic__createInternalModuleById(68), internalGetStringWidth = __intrinsic__lazy(20), PromiseReject = __intrinsic__Promise.__intrinsic__reject, isWritable, { inspect } = Bun, debug = process.env.BUN_JS_DEBUG ? console.log : () => {}, SymbolAsyncIterator = Symbol.asyncIterator, SymbolFor = Symbol.for, ArrayFrom = __intrinsic__Array.from, ArrayPrototypeFilter = __intrinsic__Array.prototype.filter, ArrayPrototypeSort = __intrinsic__Array.prototype.sort, ArrayPrototypeIndexOf = __intrinsic__Array.prototype.indexOf, ArrayPrototypeJoin = __intrinsic__Array.prototype.join, ArrayPrototypeMap = __intrinsic__Array.prototype.map, ArrayPrototypePop = __intrinsic__Array.prototype.pop, ArrayPrototypePush = __intrinsic__Array.prototype.push, ArrayPrototypeSlice = __intrinsic__Array.prototype.slice, ArrayPrototypeSplice = __intrinsic__Array.prototype.splice, ArrayPrototypeReverse = __intrinsic__Array.prototype.reverse, ArrayPrototypeShift = __intrinsic__Array.prototype.shift, ArrayPrototypeUnshift = __intrinsic__Array.prototype.unshift, RegExpPrototypeExec = __intrinsic__RegExp.prototype.exec, StringFromCharCode = __intrinsic__String.fromCharCode, StringPrototypeCharCodeAt = __intrinsic__String.prototype.charCodeAt, StringPrototypeCodePointAt = __intrinsic__String.prototype.codePointAt, StringPrototypeSlice = __intrinsic__String.prototype.slice, StringPrototypeToLowerCase = __intrinsic__String.prototype.toLowerCase, StringPrototypeEndsWith = __intrinsic__String.prototype.endsWith, StringPrototypeRepeat = __intrinsic__String.prototype.repeat, StringPrototypeStartsWith = __intrinsic__String.prototype.startsWith, StringPrototypeTrim = __intrinsic__String.prototype.trim, NumberIsNaN = Number.isNaN, NumberIsFinite = Number.isFinite, MathCeil = Math.ceil, MathFloor = Math.floor, MathMax = Math.max, DateNow = Date.now, ObjectDefineProperties = Object.defineProperties, ObjectFreeze = Object.freeze, ObjectCreate = Object.create, getStringWidth = function getStringWidth2(str, removeControlChars = !0) {
...
function charLengthLeft(str, i) {
  if (i <= 0)
    return 0;
  if (i > 1 && StringPrototypeCodePointAt.__intrinsic__call(str, i - 2) >= kUTF16SurrogateThreshold || StringPrototypeCodePointAt.__intrinsic__call(str, i - 1) >= kUTF16SurrogateThreshold)
    return 2;
  return 1;
}
  ...
  while (!0) {
    ...
    if (escaped && (ch === "O" || ch === "[")) {
      ...
      if (ch === "O") {
        ...
        let cmd = StringPrototypeSlice.__intrinsic__call(s, cmdStart), match;
        if (match = RegExpPrototypeExec.__intrinsic__call(/^(?:(\d\d?)(?:;(\d))?([~^$])|(\d{3}~))$/, cmd))
          if (match[4])
            code += match[4];
          else
...
`)
      ...
      key.name = StringFromCharCode(StringPrototypeCharCodeAt.__intrinsic__call(ch, 0) + StringPrototypeCharCodeAt.__intrinsic__call("a", 0) - 1), key.ctrl = !0;
    else if (RegExpPrototypeExec.__intrinsic__call(/^[0-9A-Za-z]$/, ch) !== null)
      key.name = StringPrototypeToLowerCase.__intrinsic__call(ch), key.shift = RegExpPrototypeExec.__intrinsic__call(/^[A-Z]$/, ch) !== null, key.meta = escaped;
    else if (escaped)
      key.name = ch.length ? __intrinsic__undefined : "escape", key.meta = !0;
    if (key.sequence = s, s.length !== 0 && (key.name !== __intrinsic__undefined || escaped))
      stream.emit("keypress", escaped ? __intrinsic__undefined : s, key);
...
function commonPrefix(strings) {
  ...
  if (strings.length === 1)
    return strings[0];
  var sorted = ArrayPrototypeSort.__intrinsic__call(ArrayPrototypeSlice.__intrinsic__call(strings)), min = sorted[0], max = sorted[sorted.length - 1];
...
function cursorTo(stream, x, y, callback) {
  ...
  if (typeof y === "function")
    callback = y, y = __intrinsic__undefined;
  if (NumberIsNaN(x))
    throw __intrinsic__makeErrorWithCode(119, "x", x);
  if (NumberIsNaN(y))
    throw __intrinsic__makeErrorWithCode(119, "y", y);
  ...
  if (typeof x !== "number")
    throw __intrinsic__makeErrorWithCode(122);
...
function clearLine(stream, dir, callback) {
  if (callback !== __intrinsic__undefined)
    validateFunction(callback, "callback");
  if (stream === null || stream === __intrinsic__undefined) {
    if (typeof callback === "function")
      process.nextTick(callback, null);
    return !0;
  }
...
function onSelfCloseWithTerminal() {
  ...
  if (input.removeListener("keypress", this[kOnKeyPress]), input.removeListener("error", this[kOnError]), input.removeListener("end", this[kOnTermEnd]), output !== null && output !== __intrinsic__undefined)
...
function InterfaceConstructor(input, output, completer, terminal) {
  ...
  if (this.line = "", this[kSubstringSearch] = null, this.output = output, this.input = input, this[kUndoStack] = [], this[kRedoStack] = [], this.history = history, this.historySize = historySize, this[kKillRing] = [], this[kKillRingCursor] = 0, this.removeHistoryDuplicates = !!removeHistoryDuplicates, this.crlfDelay = crlfDelay ? MathMax(kMincrlfDelay, crlfDelay) : kMincrlfDelay, this.completer = completer, this.setPrompt(prompt), this.terminal = !!terminal, this[kLineObjectStream] = __intrinsic__undefined, input.on("error", this[kOnError]), !this.terminal)
    ...
    if (emitKeypressEvents(input, this), input.on("keypress", this[kOnKeyPress]), input.on("end", this[kOnTermEnd]), this[kSetRawMode](!0), this.terminal = !0, this.cursor = 0, this.historyIndex = -1, output !== null && output !== __intrinsic__undefined)
...
__intrinsic__toClass(InterfaceConstructor, "InterfaceConstructor", EventEmitter);
var _Interface = class Interface extends InterfaceConstructor {
  ...
  [kQuestion](query, cb) {
    if (this.closed)
      throw __intrinsic__makeErrorWithCode(257, "readline");
  ...
  [kWriteToOutput](stringToWrite) {
    if (validateString(stringToWrite, "stringToWrite"), this.output !== null && this.output !== __intrinsic__undefined)
  ...
  [kAddHistory]() {
    ...
    if (this.historySize === 0)
      return this.line;
    if (StringPrototypeTrim.__intrinsic__call(this.line).length === 0)
      return this.line;
    if (this.history.length === 0 || this.history[0] !== this.line) {
      if (this.removeHistoryDuplicates) {
        var dupIndex = ArrayPrototypeIndexOf.__intrinsic__call(this.history, this.line);
        if (dupIndex !== -1)
          ArrayPrototypeSplice.__intrinsic__call(this.history, dupIndex, 1);
      }
      if (ArrayPrototypeUnshift.__intrinsic__call(this.history, this.line), this.history.length > this.historySize)
        ArrayPrototypePop.__intrinsic__call(this.history);
    }
    this.historyIndex = -1;
  ...
  [kNormalWrite](b) {
    if (b === __intrinsic__undefined)
      return;
    var string = this[kDecoder].write(b);
    if (this[kSawReturnAt] && DateNow() - this[kSawReturnAt] <= this.crlfDelay) {
      if (StringPrototypeCodePointAt.__intrinsic__call(string) === 10)
        string = StringPrototypeSlice.__intrinsic__call(string, 1);
      this[kSawReturnAt] = 0;
    }
    var newPartContainsEnding = RegExpPrototypeExec.__intrinsic__call(lineEnding, string);
    if (newPartContainsEnding !== null) {
      if (this[kLine_buffer])
        string = this[kLine_buffer] + string, this[kLine_buffer] = null, lineEnding.lastIndex = 0, newPartContainsEnding = RegExpPrototypeExec.__intrinsic__call(lineEnding, string);
  ...
  [kInsertString](c) {
    if (this[kBeforeEdit](this.line, this.cursor), this.cursor < this.line.length) {
      var beg = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor), end = StringPrototypeSlice.__intrinsic__call(this.line, this.cursor, this.line.length);
  ...
  async[kTabComplete](lastKeypressWasTab) {
    this.pause();
    var string = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor), value;
    try {
  ...
  [kTabCompleter](lastKeypressWasTab, { 0: completions, 1: completeOn }) {
    ...
    if (StringPrototypeStartsWith.__intrinsic__call(prefix, completeOn) && prefix.length > completeOn.length) {
      ...
      this.line = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor - completeOn.length) + prefix + StringPrototypeSlice.__intrinsic__call(this.line, this.cursor, this.line.length), this.cursor = this.cursor - completeOn.length + prefix.length, this[kRefreshLine]();
      return;
    }
    if (!lastKeypressWasTab)
      return;
    this[kBeforeEdit](this.line, this.cursor);
    var completionsWidth = ArrayPrototypeMap.__intrinsic__call(completions, (e) => getStringWidth(e)), width = MathMax.__intrinsic__apply(null, completionsWidth) + 2, maxColumns = MathFloor(this.columns / width) || 1;
    if (maxColumns === __intrinsic__Infinity)
      maxColumns = 1;
    var output = `\r
...
`;
  ...
  [kWordLeft]() {
    if (this.cursor > 0) {
      var leading = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor), reversed = ArrayPrototypeJoin.__intrinsic__call(ArrayPrototypeReverse.__intrinsic__call(ArrayFrom(leading)), ""), match = RegExpPrototypeExec.__intrinsic__call(/^\s*(?:[^\w\s]+|\w+)?/, reversed);
      this[kMoveCursor](-match[0].length);
    }
  }
  [kWordRight]() {
    if (this.cursor < this.line.length) {
      var trailing = StringPrototypeSlice.__intrinsic__call(this.line, this.cursor), match = RegExpPrototypeExec.__intrinsic__call(/^(?:\s+|[^\w\s]+|\w+)\s*/, trailing);
      this[kMoveCursor](match[0].length);
    }
  }
  [kDeleteLeft]() {
    if (this.cursor > 0 && this.line.length > 0) {
      ...
      this.line = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor - charSize) + StringPrototypeSlice.__intrinsic__call(this.line, this.cursor, this.line.length), this.cursor -= charSize, this[kRefreshLine]();
    }
  }
  [kDeleteRight]() {
    if (this.cursor < this.line.length) {
      ...
      this.line = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor) + StringPrototypeSlice.__intrinsic__call(this.line, this.cursor + charSize, this.line.length), this[kRefreshLine]();
    }
  }
  [kDeleteWordLeft]() {
    if (this.cursor > 0) {
      this[kBeforeEdit](this.line, this.cursor);
      var leading = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor), reversed = ArrayPrototypeJoin.__intrinsic__call(ArrayPrototypeReverse.__intrinsic__call(ArrayFrom(leading)), ""), match = RegExpPrototypeExec.__intrinsic__call(/^\s*(?:[^\w\s]+|\w+)?/, reversed);
      leading = StringPrototypeSlice.__intrinsic__call(leading, 0, leading.length - match[0].length), this.line = leading + StringPrototypeSlice.__intrinsic__call(this.line, this.cursor, this.line.length), this.cursor = leading.length, this[kRefreshLine]();
    }
  }
  [kDeleteWordRight]() {
    if (this.cursor < this.line.length) {
      this[kBeforeEdit](this.line, this.cursor);
      var trailing = StringPrototypeSlice.__intrinsic__call(this.line, this.cursor), match = RegExpPrototypeExec.__intrinsic__call(/^(?:\s+|\W+|\w+)\s*/, trailing);
      this.line = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor) + StringPrototypeSlice.__intrinsic__call(trailing, match[0].length), this[kRefreshLine]();
    }
  }
  [kDeleteLineLeft]() {
    this[kBeforeEdit](this.line, this.cursor);
    var del = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor);
    this.line = StringPrototypeSlice.__intrinsic__call(this.line, this.cursor), this.cursor = 0, this[kPushToKillRing](del), this[kRefreshLine]();
  }
  [kDeleteLineRight]() {
    this[kBeforeEdit](this.line, this.cursor);
    var del = StringPrototypeSlice.__intrinsic__call(this.line, this.cursor);
    this.line = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor), this[kPushToKillRing](del), this[kRefreshLine]();
  }
  [kPushToKillRing](del) {
    if (!del || del === this[kKillRing][0])
      return;
    ArrayPrototypeUnshift.__intrinsic__call(this[kKillRing], del), this[kKillRingCursor] = 0;
    while (this[kKillRing].length > kMaxLengthOfKillRing)
      ArrayPrototypePop.__intrinsic__call(this[kKillRing]);
  }
  [kYank]() {
  ...
  [kYankPop]() {
    ...
    if (this[kKillRing].length > 1) {
      ...
      var currentYank = this[kKillRing][this[kKillRingCursor]], head = StringPrototypeSlice.__intrinsic__call(this.line, 0, this.cursor - lastYank.length), tail = StringPrototypeSlice.__intrinsic__call(this.line, this.cursor);
      this.line = head + currentYank + tail, this.cursor = head.length + currentYank.length, this[kRefreshLine]();
    }
  }
  clearLine() {
    this[kMoveCursor](+__intrinsic__Infinity), this[kWriteToOutput](`\r
`), this.line = "", this.cursor = 0, this.prevRows = 0;
  ...
  [kHistoryNext]() {
    if (this.historyIndex >= 0) {
      ...
      while (index >= 0 && (!StringPrototypeStartsWith.__intrinsic__call(this.history[index], search) || this.line === this.history[index]))
        index--;
      if (index === -1)
        this.line = search;
      else
  ...
  [kHistoryPrev]() {
    if (this.historyIndex < this.history.length && this.history.length) {
      this[kBeforeEdit](this.line, this.cursor);
      var search = this[kSubstringSearch] || "", index = this.historyIndex + 1;
      while (index < this.history.length && (!StringPrototypeStartsWith.__intrinsic__call(this.history[index], search) || this.line === this.history[index]))
        index++;
    ...
    if (keyCtrl && keyShift)
      ...
      switch (keyName) {
        ...
        case "k":
          ...
          break;
        case "a":
          this[kMoveCursor](-__intrinsic__Infinity);
          break;
        case "e":
          this[kMoveCursor](+__intrinsic__Infinity);
          break;
        ...
        default:
          if (typeof s === "string" && s) {
            ...
            while ((nextMatch = RegExpPrototypeExec.__intrinsic__call(lineEnding, s)) !== null)
              this[kInsertString](StringPrototypeSlice.__intrinsic__call(s, lastIndex, nextMatch.index)), { lastIndex } = lineEnding, this[kLine](), lineEnding.lastIndex = lastIndex;
            this[kInsertString](StringPrototypeSlice.__intrinsic__call(s, lastIndex));
          }
      }
    }
  }
  [SymbolAsyncIterator]() {
    if (this[kLineObjectStream] === __intrinsic__undefined)
...
function Interface2(input, output, completer, terminal) {
  ...
  if (InterfaceConstructor.__intrinsic__call(this, input, output, completer, terminal), process.env.TERM === "dumb")
    this._ttyWrite = _ttyWriteDumb.bind(this);
}
__intrinsic__toClass(Interface2, "Interface", _Interface);
...
Interface2.prototype.question[promisify.custom] = {
  question(query, options) {
    ...
    if (signal && signal.aborted)
      return PromiseReject(__intrinsic__makeAbortError(__intrinsic__undefined, { cause: signal.reason }));
...
class Readline {
  ...
  #stream;
  #todo = [];
  constructor(stream, options = __intrinsic__undefined) {
    if (isWritable ??= (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 117) || __intrinsic__createInternalModuleById(117)).isWritable, !isWritable(stream))
      throw __intrinsic__makeErrorWithCode(118, "stream", "Writable", stream);
  ...
  cursorTo(x, y = __intrinsic__undefined) {
    ...
    if (this.#autoCommit)
      ...
      ArrayPrototypePush.__intrinsic__call(this.#todo, data);
    return this;
  }
  moveCursor(dx, dy) {
    if (dx || dy) {
  ...
  commit() {
    let { resolve, reject, promise } = __intrinsic__newPromiseCapability(__intrinsic__Promise);
    try {
      let data = ArrayPrototypeJoin.__intrinsic__call(this.#todo, "");
...
var PromisesInterface = class Interface3 extends _Interface {
  ...
  question(query, options = kEmptyObject) {
    ...
    let { promise, resolve, reject } = __intrinsic__newPromiseCapability(__intrinsic__Promise);
    var cb = resolve;
    if (options?.signal) {
      var onAbort = () => {
        this[kQuestionCancel](), reject(__intrinsic__makeAbortError(__intrinsic__undefined, { cause: signal.reason }));
      };
      signal.addEventListener("abort", onAbort, { once: !0 }), cb = (answer) => {
        signal.removeEventListener("abort", onAbort), resolve(answer);
      };
