// @bun
// build/release/tmp_modules/node/path.ts
var $, { validateString } = __intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68) || __intrinsic__createInternalModuleById(68), [bindingPosix, bindingWin32] = __intrinsic__lazy(73), toNamespacedPathPosix = bindingPosix.toNamespacedPath.bind(bindingPosix), toNamespacedPathWin32 = bindingWin32.toNamespacedPath.bind(bindingWin32), posix = {
