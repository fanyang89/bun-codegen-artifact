// @bun
// build/release/tmp_modules/bun/sqlite.ts
var $;
var defineProperties = Object.defineProperties, toStringTag = Symbol.toStringTag, isArray = __intrinsic__Array.isArray, isTypedArray = __intrinsic__ArrayBuffer.isView, internalFieldTuple;
...
var getController = (db, _self) => {
  ...
  try {
    before.run();
    let result = fn.__intrinsic__apply(this, args);
