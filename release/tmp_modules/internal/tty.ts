...
// Sourced from src/js/internal/tty.ts
...
function getColorDepth(env: NodeJS.ProcessEnv) {
  ...
  if (process.platform === "win32") {
    ...
    if (OSRelease === undefined) {
      const { release } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 105/*node:os*/) || __intrinsic__createInternalModuleById(105/*node:os*/));
