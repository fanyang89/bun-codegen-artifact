...
// Sourced from src/js/internal/streams/operators.ts


"use strict";

const { validateAbortSignal, validateInteger, validateObject } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68/*internal/validators*/) || __intrinsic__createInternalModuleById(68/*internal/validators*/));
const { kWeakHandler, kResistStopPropagation } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32/*internal/shared*/) || __intrinsic__createInternalModuleById(32/*internal/shared*/));
...
const staticCompose = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 42/*internal/streams/compose*/) || __intrinsic__createInternalModuleById(42/*internal/streams/compose*/));
const { addAbortSignalNoValidate } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 41/*internal/streams/add-abort-signal*/) || __intrinsic__createInternalModuleById(41/*internal/streams/add-abort-signal*/));
const { isWritable, isNodeStream } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 58/*internal/streams/utils*/) || __intrinsic__createInternalModuleById(58/*internal/streams/utils*/));

const MathFloor = Math.floor;
const PromiseResolve = Promise.__intrinsic__resolve.bind(Promise);
const PromiseReject = Promise.__intrinsic__reject.bind(Promise);
...
async function reduce(reducer, initialValue, options) {
  ...
  if (options?.signal?.aborted) {
    const err = __intrinsic__makeAbortError(undefined, { cause: options.signal.reason });
...
async function toArray(options) {
  ...
  for await (const val of this) {
    if (options?.signal?.aborted) {
      throw __intrinsic__makeAbortError(undefined, { cause: options.signal.reason });
    }
