...
// Sourced from src/js/internal/streams/transform.ts
...
const { getHighWaterMark } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 56/*internal/streams/state*/) || __intrinsic__createInternalModuleById(56/*internal/streams/state*/));
...
$ = Transform as unknown as typeof import("node:stream").Transform;
;$$EXPORT$$($).$$EXPORT_END$$;
