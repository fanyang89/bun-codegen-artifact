...
// Sourced from src/js/internal/streams/pipeline.ts
...
const { once } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 32/*internal/shared*/) || __intrinsic__createInternalModuleById(32/*internal/shared*/));
...
const { validateFunction, validateAbortSignal } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 68/*internal/validators*/) || __intrinsic__createInternalModuleById(68/*internal/validators*/));
const {
  isIterable,
  isReadable,
...
function destroyer(stream, reading, writing) {
  ...
  return {
    destroy: err => {
      if (finished) return;
      finished = true;
      destroyImpl.destroyer(stream, err || __intrinsic__makeErrorWithCode(228, "pipe"));
    },
    cleanup,
  };
}
...
async function* fromReadable(val) {
  Readable ??= (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 55/*internal/streams/readable*/) || __intrinsic__createInternalModuleById(55/*internal/streams/readable*/));
...
function pipelineImpl(streams, callback, opts?) {
  ...
  function abort() {
    finishImpl(__intrinsic__makeAbortError(undefined, { cause: outerSignal?.reason }));
  }
  ...
  for (let i = 0; i < streams.length; i++) {
    ...
    if (i === 0) {
      ...
      if (reading) {
        ...
        PassThrough ??= (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 53/*internal/streams/passthrough*/) || __intrinsic__createInternalModuleById(53/*internal/streams/passthrough*/));
