...
// Sourced from src/js/internal/cluster/child.ts
...
const onInternalMessage = __intrinsic__lazy(5);
...
function shared(message, { handle, indexesKey, index }, cb) {
  ...
  !(IS_BUN_DEVELOPMENT?$assert(handles.has(key) === false,"handles.has(key) === false"):void 0);
