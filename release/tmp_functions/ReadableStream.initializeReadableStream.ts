...
$$capture_start$$(function(underlyingSource,strategy,) {  if (underlyingSource === undefined) underlyingSource = { __intrinsic__bunNativePtr: undefined, __intrinsic__lazy: false } as UnderlyingSource;
  ...
  this.__intrinsic__disturbed = false;
  ...
  this.__intrinsic__bunNativePtr = __intrinsic__getByIdDirectPrivate(underlyingSource, "bunNativePtr") ?? undefined;
  ...
  if (!isLazy && (pullFn = __intrinsic__getByIdDirectPrivate(underlyingSource, "pull")) !== undefined) {
