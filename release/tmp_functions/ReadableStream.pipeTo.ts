...
$$capture_start$$(function(destination) {  if (!__intrinsic__isReadableStream(this)) return Promise.__intrinsic__reject(__intrinsic__makeErrorWithCode(138, "ReadableStream"));
