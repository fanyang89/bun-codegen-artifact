...
$$capture_start$$(function(stream) {  const inFlightWriteRequest = __intrinsic__getByIdDirectPrivate(stream, "inFlightWriteRequest");
  !(IS_BUN_DEVELOPMENT?$assert(inFlightWriteRequest !== undefined,"inFlightWriteRequest !== undefined"):void 0);
  inFlightWriteRequest.resolve.__intrinsic__call();
