...
$$capture_start$$(function(chunk) {  if (!__intrinsic__isWritableStreamDefaultWriter(this)) return Promise.__intrinsic__reject(__intrinsic__makeErrorWithCode(138, "WritableStreamDefaultWriter"));
