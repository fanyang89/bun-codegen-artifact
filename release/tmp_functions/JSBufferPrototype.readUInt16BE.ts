...
$$capture_start$$(function(offset) {  if (offset === undefined) offset = 0;
  if (typeof offset !== "number" || this[offset] === undefined || this[offset + 1] === undefined)
    __intrinsic__checkBufferRead(this, offset, 2);
  return (this.__intrinsic__dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getUint16(offset, false);
}).$$capture_end$$;
